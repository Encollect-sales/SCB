...
PerformanceReportTestPage08(){
    ...
    cy.contains("Performance Report (Monthly)").should('exist').click({ force: true });
    cy.wait(2000);
    cy.contains('Month').scrollIntoView().should('exist');
    cy.wait(2000);
    cy.contains("ProductGroup(s)").scrollIntoView().should('exist');
...
PerformanceReportTestPage013(){
   ...
   cy.contains('Month').scrollIntoView().should('exist');
cy.contains('ProductGroup(s)').scrollIntoView().should('exist');
cy.contains('Product(s)').scrollIntoView().should('exist');
cy.contains('SubProduct(s)').scrollIntoView().should('exist');
cy.contains('City(s)').scrollIntoView().should('exist');
cy.contains('Branch(s)').scrollIntoView().should('exist');
cy.contains('User Branch(s)').scrollIntoView().should('exist');
cy.contains('Staff(s)').scrollIntoView().should('exist');
...
cy.get('.ng-dropdown-panel-items')
  ...
  .then(options => {
    ...
    cy.contains('Generate Report').click({force:true});
    cy.wait(900);
    cy.contains('The MonthYear field is required').should('exist');
