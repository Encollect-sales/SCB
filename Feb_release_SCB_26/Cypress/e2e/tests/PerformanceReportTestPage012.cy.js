...
describe('Performance Page - Verify Product Group dropdown is visible and selectable', () => {
    ...
    it('Verify Product Group dropdown is visible and selectable', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            performanceReportPage.PerformanceReportTestPage012();
