...
describe('Performance Report (Monthly) - Verify Monthly Report is disabled for Tele Calling agency users', () => {
    ...
    it('Verify Monthly Report is disabled for Tele Calling agency users', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            performanceReportPage.PerformanceReportTestPage039();
