...
describe('Performance Page - Headers shown: No. of Accounts, BOM POS, % Count, % BOM POS', () => {
    ...
    it('Headers shown: No. of Accounts, BOM POS, % Count, % BOM POS', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            performanceReportPage.PerformanceReportTestPage024();
