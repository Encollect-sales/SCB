...
describe('Performance Page - Monthly Performance Report page is displayed (Agency staff)', () => {
    ...
    it('Monthly Performance Report page is displayed (Agency staff)', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            performanceReportPage.PerformanceReportTestPage033();
