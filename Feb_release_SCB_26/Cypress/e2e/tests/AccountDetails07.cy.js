...
describe('Account Details -Verify masking in Demographic Details widget', () => {
    ...
    it('Verify masking in Demographic Details widget', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            accountdetailsPage.AccountDetailsPage07();
