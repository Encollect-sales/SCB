...
describe('Performance Page - Verify both MTD and Monthly reports are grouped under Performance Reports', () => {
    ...
    it('Verify both MTD and Monthly reports are grouped under Performance Reports', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            performanceReportPage.PerformanceReportTestPage03();
