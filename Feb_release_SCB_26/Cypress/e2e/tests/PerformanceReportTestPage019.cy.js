...
describe('Performance Page - Verify Month dropdown checkbox selection behavior', () => {
    ...
    it('Verify Month dropdown checkbox selection behavior', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            performanceReportPage.PerformanceReportTestPage019();
