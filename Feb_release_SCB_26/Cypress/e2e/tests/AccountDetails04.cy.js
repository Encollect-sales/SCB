...
describe('Account Details -Verify masking in Official contact details', () => {
    ...
    it('Verify masking in Official contact details', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            accountdetailsPage.AccountDetailsPage04();
