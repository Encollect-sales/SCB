...
describe('Performance Page - Navigate to Performance Report → Click Agency button → Open Month dropdown. Dropdown list should be scrollable.', () => {
    ...
    it('Navigate to Performance Report → Click Agency button → Open Month dropdown. Dropdown list should be scrollable.', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            performanceReportPage.PerformanceReportTestPage56();
