...
describe('Performance Page - Monthly report grid displayed for selected month', () => {
    ...
    it('Monthly report grid displayed for selected month', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            performanceReportPage.PerformanceReportTestPage023();
