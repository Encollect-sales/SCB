...
describe('Performance Page - Navigate to Performance Report → Click Agency button → Click Month dropdown. Month dropdown list should be displayed.', () => {
    ...
    it('Navigate to Performance Report → Click Agency button → Click Month dropdown. Month dropdown list should be displayed.', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            performanceReportPage.PerformanceReportTestPage45();
