...
describe('Account Details - Verify masked mobile & email in Latest section', () => {
    ...
    it('Verify masked mobile & email in Latest section', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            accountdetailsPage.AccountDetailsPage03();
