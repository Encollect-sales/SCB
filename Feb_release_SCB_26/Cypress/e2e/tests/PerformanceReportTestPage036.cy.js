...
describe('Performance Report (MTD) - select all the mandetory fields and generate results', () => {
    ...
    it('Select all the mandetory fields and generate results (MTD)', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            performanceReportPage.PerformanceReportTestPage035();
