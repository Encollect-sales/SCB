...
describe('Settlement - CityCollectionHead L3 -Verify user can renegotiate the settlement request with remarks - Special characters validations', () => {
    ...
    it( 'Verify user can renegotiate the settlement request with remarks', () => {
        ...
        getTestData('loginData', 'CityCollectionHeadLogin').then(user => {
            ...
            settlementPage.RenegotiateCaseStatusvalidations();
