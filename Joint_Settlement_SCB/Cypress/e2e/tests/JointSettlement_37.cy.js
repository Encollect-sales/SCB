...
describe('Settlement -ZonalCollectionHead L6- Verify user can select a settlement request with JA badge', () => {
    ...
    it('Verify user can select a settlement request with JA badge', () => {
