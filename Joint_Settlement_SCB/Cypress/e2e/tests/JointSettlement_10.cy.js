...
describe('Settlement - CollectionManager L2 - Verify user can deny the settlement request with remarks', () => {
    ...
    it( 'Verify user can deny the settlement request with remarks', () => {
