...
describe('Settlement - ZonalCollectionHead - L6 -Verify Approve submission without entering remarks', () => {
    ...
    it( 'Verify Approve submission without entering remarks', () => {
        ...
        getTestData('loginData', 'ZonalCollectionHeadLogin').then(user => {
          ...
          settlementPage.ApproveWithoutRemarks();
