...
describe('Settlement - ZonalCollectionHead- L6 -Verify Reject submission without entering remarks', () => {
    ...
    it( 'Verify Reject submission without entering remarks', () => {
        ...
        getTestData('loginData', 'ZonalCollectionHeadLogin').then(user => {
          ...
          settlementPage.RejectWithoutRemarks();
