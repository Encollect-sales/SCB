...
describe('UserManagement -If Agency name is blank then system will throw an error as "Agency Name is required"', () => {
    let loginPage;
    ...
    it('User download the agent template If Agency name is blank then system will throw an error as "Agency Name is required"- TC_ID_02', () => {
