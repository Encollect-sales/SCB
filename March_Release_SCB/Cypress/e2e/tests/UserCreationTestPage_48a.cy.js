...
describe('UserManagement -If user enters First Name which is less than 1 character then system will throw an error as "First Name must be at least 1 character long"', () => {
    let loginPage;
    ...
    it('If user enters First Name which is less than 1 character then system will throw an error as "First Name must be at least 1 character long" - TC_ID_48a', () => {
