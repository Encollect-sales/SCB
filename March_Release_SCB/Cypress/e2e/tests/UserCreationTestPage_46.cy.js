...
describe('UserManagement -User should be able to see the list of fields in staff template as described in step.', () => {
    let loginPage;
    ...
    it('User should be able to see the list of fields in staff template as described in step. - TC_ID_46', () => {
        getTestData('loginData', 'login2').then(user => {
            ...
            const data = {
                ...
                usercreationpage.UserCreationStaffTemplate_upload01();
            });
        });
    });
