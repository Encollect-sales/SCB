...
describe('UserManagement -If Agency Code is blank then system will throw an error as "Agency Code is Required"', () => {
    let loginPage;
    ...
    it('User download the agent template If Agency Code is blank then system will throw an error as "Agency Code is Required"- TC_ID_02', () => {
