...
describe('UserManagement -If entered supervisor email id greater than 50 characters then system will throw an error as Supervisor email id cannot be more than 50 characters', () => {
    let loginPage;
    ...
    it('User download the agent template If entered supervisor email id greater than 50 characters then system will throw an error as Supervisor email id cannot be more than 50 characters- TC_ID_02', () => {
