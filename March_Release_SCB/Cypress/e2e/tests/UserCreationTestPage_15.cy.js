...
describe('UserManagement -If Department is blank, then system will throw an error as "Address is Required"', () => {
    let loginPage;
    ...
    it('User download the agent template If Department is blank, then system will throw an error as "Address is Required" - TC_ID_02', () => {
