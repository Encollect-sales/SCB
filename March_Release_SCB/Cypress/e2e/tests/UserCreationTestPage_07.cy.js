...
describe('UserManagement -If entered Date is of future date then system will throw an error as "Date is invalid"', () => {
    let loginPage;
    ...
    it('User download the agent template If entered Date is of future date then system will throw an error as "Date is invalid" - TC_ID_02', () => {
