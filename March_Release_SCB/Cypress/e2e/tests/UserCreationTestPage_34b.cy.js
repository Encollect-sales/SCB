...
describe('UserManagement -When  user enters Mobile number which is less than or greater than 10 digits then system will throw an error as "10 digits are required"', () => {
    let loginPage;
    ...
    it('User download the agent template When  user enters Mobile number which is less than or greater than 10 digits then system will throw an error as "10 digits are required" - TC_ID_02', () => {
