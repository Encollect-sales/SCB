...
describe('UserManagement -If user enters special characters then system will throw an error as "Please enter valid Employee Id"', () => {
    let loginPage;
    ...
    it('If user enters special characters then system will throw an error as "Please enter valid Employee Id" - TC_ID_47a', () => {
