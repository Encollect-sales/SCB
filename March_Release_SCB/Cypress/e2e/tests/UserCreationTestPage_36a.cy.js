...
describe('UserManagement -If First Agreement Date date is of future then system will throw an error as "First Agreement Date date cannot be future date."', () => {
    let loginPage;
    ...
    it('User download the agent templateIf First Agreement Date date is of future then system will throw an error as "First Agreement Date date cannot be future date." - TC_ID_02', () => {
