...
describe('UserManagement -When Mobile Number is blank then system will throw an error as "Mobile Number is required"', () => {
    let loginPage;
    ...
    it('When Mobile Number is blank then system will throw an error as "Mobile Number is required" - TC_ID_51', () => {
