...
describe('UserManagement - User to upload the bulk staff creation file by selecting the upload type as staff and by clicking on upload button.', () => {
    let loginPage;
    ...
    it('User to upload the bulk staff creation file by selecting the upload type as staff and by clicking on upload button. - TC_ID_54', () => {
        getTestData('loginData', 'login2').then(user => {
         ...
         const email = `${fn.toLowerCase()}@yopmail.com`; 
            ...
            const data = {
                ...
                usercreationpage.UserCreationStaffTemplate_upload02();
            });
        });
    });
