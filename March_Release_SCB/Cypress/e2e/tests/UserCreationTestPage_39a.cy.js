...
describe('UserManagement -User to enter Remarks with alphanumeric characters in the bulk upload of agency and user creation template.', () => {
    let loginPage;
    ...
    it('User download the agent template User to enter Remarks with alphanumeric charactersin the bulk upload of agency and user creation template. - TC_ID_02', () => {
