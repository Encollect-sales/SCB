...
describe('UserManagement -If authorization card expiry date is of past date or date format is incorrect then system will throw an error as "Authorization card expiry cannot be of past date"', () => {
    let loginPage;
    ...
    it('User download the agent template If authorization card expiry date is of past date or date format is incorrect then system will throw an error as "Authorization card expiry cannot be of past date" - TC_ID_02', () => {
