...
describe('UserManagement -If Employee id is blank, then system will throw an error as "Employee Id is required"', () => {
    let loginPage;
    ...
    it('If Employee id is blank, then system will throw an error as "Employee Id is required" - TC_ID_47', () => {
