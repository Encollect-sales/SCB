...
describe('UserManagement -If user enters first name more than 40 characters then system will throw an error as First Name cannot be more than 40 characters', () => {
    let loginPage;
    ...
    it('User download the agent template If user enters first name more than 40 characters then system will throw an error as First Name cannot be more than 40 characters- TC_ID_01', () => {
        getTestData('loginData', 'login2').then(user => {
         ...
         const email = `${firstName.toLowerCase()}@yopmail.com`; // N2 - short, simple
            ...
            const data = {
               'A2': 'FOS',
                'B2': 'rajivkubhartiajdeorugyhgkndflskrugherijgknverihfknlsrkgjkhikgnlerogufkjblvrbkegjfugthjlfuoghlgjerhgiefbjn',
                'C2': lastName,
                'D2': '13911',
                'E2': '',
                'F2': '435454',
