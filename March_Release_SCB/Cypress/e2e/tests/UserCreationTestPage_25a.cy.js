...
describe('UserManagement -If user enters RecommendingOfficer more than 40 characters then system will throw an error as Recommending Officer cannot be more than 40 characters', () => {
    let loginPage;
    ...
    it('User download the agent template If user enters RecommendingOfficer more than 40 characters then system will throw an error as RecommendingOfficercannot be more than 40 characters- TC_ID_02', () => {
        getTestData('loginData', 'login2').then(user => {
         ...
         //###########################################################################################################
            ...
            const data = {
                ...
                'C2': agencycode,
                'D2':name,
                'E2': '21985621333335683256341532896543216853253465132256',
                'F2': 'Collections',
                'G2': 'Field Agents',
                'H2': '12345321',
                'I2':'PANCA9614B',
