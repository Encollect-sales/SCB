...
describe('UserManagement -If user enters numbers or special characters then system will throw an error as "Enter Valid Name"', () => {
    let loginPage;
    ...
    it('User download the agent template If user enters numbers or special characters then system will throw an error as "Enter Valid Name" - TC_ID_02', () => {
