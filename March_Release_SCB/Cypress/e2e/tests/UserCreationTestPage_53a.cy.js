...
describe('UserManagement -If entered Designation does not exist in db then system will throw an error as "Designation is invalid"', () => {
    let loginPage;
    ...
    it('If entered Designation does not exist in db then system will throw an error as "Designation is invalid"- TC_ID_53a', () => {
