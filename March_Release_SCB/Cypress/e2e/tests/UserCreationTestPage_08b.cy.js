...
describe('UserManagement -If DRA Unique Registration Number is greater than 16 digits then system will throw an error as "DRA Unique Registration Number cannot be more than 16 digits."', () => {
    let loginPage;
    ...
    it('User download the agent template If DRA Unique Registration Number is greater than 16 digits then system will throw an error as "DRA Unique Registration Number cannot be more than 16 digits." - TC_ID_02', () => {
