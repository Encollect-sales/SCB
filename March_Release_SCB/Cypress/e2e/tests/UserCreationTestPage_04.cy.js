...
describe('UserManagement -If the entered agency code does not exist in db or agency is not approved then system will throw an error as "Agency Code does not exist or not approved"', () => {
    let loginPage;
    ...
    it('User download the agent template If the entered agency code does not exist in db or agency is not approved then system will throw an error as "Agency Code does not exist or not approved"- TC_ID_02', () => {
