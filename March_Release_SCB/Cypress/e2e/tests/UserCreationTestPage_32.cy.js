...
describe('UserManagement -If Is Parent agency  is blank then system will throw an error as " Registered Agency Address is required"', () => {
    let loginPage;
    ...
    it('User download the agent template If Is Parent agency  is blank then system will throw an error as "Registered Agency Addressis required" - TC_ID_02', () => {
