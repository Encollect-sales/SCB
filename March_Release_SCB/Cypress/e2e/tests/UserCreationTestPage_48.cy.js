...
describe('UserManagement -If user enters numbers or special characters then system will throw an error as "Please enter valid First Name"', () => {
    let loginPage;
    ...
    it('If user enters numbers or special characters then system will throw an error as "Please enter valid First Name" - TC_ID_48', () => {
