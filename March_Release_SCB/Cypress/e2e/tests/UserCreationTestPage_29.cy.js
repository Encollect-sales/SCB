...
describe('UserManagement -If the Pancard is blank, then system will throw an error as "Pancard is required"', () => {
    let loginPage;
    ...
    it('User download the agent template If the Pancard is blank, then system will throw an error as "Pancard is required" - TC_ID_02', () => {
