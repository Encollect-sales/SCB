...
describe('UserManagement -If entered email is incorrect then system will throw an error as "Please Enter valid email id"', () => {
    let loginPage;
    ...
    it('User download the agent template If entered email is incorrect then system will throw an error as "Please Enter valid email id"- TC_ID_02', () => {
