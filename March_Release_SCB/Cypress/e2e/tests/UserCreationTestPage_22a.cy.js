...
describe('UserManagement -If Parent agency is Yes, then this field should be blank and will throw an error if value is added against this column "Parent Agency Code is not required".', () => {
    let loginPage;
    ...
    it('User download the agent template If Parent agency is Yes, then this field should be blank and will throw an error if value is added against this column "Parent Agency Code is not required"- TC_ID_02', () => {
