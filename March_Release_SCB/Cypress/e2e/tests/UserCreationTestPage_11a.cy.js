...
describe('UserManagement -If entered DOB is of future date then system will throw an error as "DOB is invalid"', () => {
    let loginPage;
    ...
    it('User download the agent template If entered DOB is of future date then system will throw an error as "DOB is invalid"- TC_ID_02', () => {
