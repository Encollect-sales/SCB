...
describe('UserManagement -When  user enters alphabets or special characters then system will throw an error as "Only numbers are allowed"', () => {
    let loginPage;
    ...
    it('User download the agent template When  user enters alphabets or special characters then system will throw an error as "Only numbers are allowed" - TC_ID_02', () => {
