...
describe('UserManagement -If user enters fathers name more than 40 characters then system will throw an error as Fathers Name cannot be more than 40 characters', () => {
    let loginPage;
    ...
    it('User download the agent template If user enters fathers name more than 40 characters then system will throw an error as Fathers Name cannot be more than 40 characters. - TC_ID_02', () => {
         ...
         const email = `${firstName.toLowerCase()}@yopmail.com`; // N2 - short, simple
            ...
            const data = {
               'A2': 'Telecaller',
                ...
                'M2': phoneNumber,
                'N2': email,
                'O2': 'yofrhlrgtriughdknghijklnbinjgklbldfkjghilkbnrgihlrngkjniryhdklgjhiiuthp',
                'P2': 'bakori',
                'Q2': '765523',
                'R2': '19-10-2022',
                'S2': '19-10-2023',
