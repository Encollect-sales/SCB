...
describe('UserManagement -If user enters first name more than 40 characters then system will throw an error as last Name cannot be more than 40 characters', () => {
    let loginPage;
    ...
    it('User download the agent template If user enters first name more than 40 characters then system will throw an error as last Name cannot be more than 40 characters- TC_ID_02', () => {
        getTestData('loginData', 'login2').then(user => {
         ...
         const email = `${firstName.toLowerCase()}@yopmail.com`; // N2 - short, simple
            ...
            const data = {
               'A2': 'FOS',
                'B2': firstName,
                'C2': 'ksingeahuihdfngitbgdfkngfhgfhjdkfgbtriuhfknmhtfihbdnfkbidfgnhkja',
                'D2': '10004',
                'E2': '',
                'F2': '435454',
                'G2': '',
