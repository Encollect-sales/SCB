...
describe('UserManagement -If Department is blank, then system will throw an error as "Collection employment date is Required"', () => {
    let loginPage;
    ...
    it('User download the agent template If Department is blank, then system will throw an error as "Collection employment date is Required" - TC_ID_02', () => {
