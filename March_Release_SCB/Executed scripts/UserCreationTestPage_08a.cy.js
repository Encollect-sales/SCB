...
describe('UserManagement -If DRA Unique Registration Number is less than 9 digits then system will throw an error as "DRA Unique Registration Number must be atleast 9 digits long"', () => {
    let loginPage;
    ...
    it('User download the agent template If DRA Unique Registration Number is less than 9 digits then system will throw an error as "DRA Unique Registration Number must be atleast 9 digits long" - TC_ID_02', () => {
