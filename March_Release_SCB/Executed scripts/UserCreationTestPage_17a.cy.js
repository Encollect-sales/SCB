...
describe('UserManagement -If collection employment date is of future date or date format is incorrect then system will throw an error as "Collection employment date is invalid"', () => {
    let loginPage;
    ...
    it('User download the agent template If collection employment date is of future date or date format is incorrect then system will throw an error as "Collection employment date is invalid" - TC_ID_02', () => {
