...
describe('UserManagement -If Authorization card expiry date is blank, then system will throw an error as "Authorization card expiry date is Required"', () => {
    let loginPage;
    ...
    it('User download the agent template If Authorization card expiry date is blank, then system will throw an error as "Authorization card expiry date is Required" - TC_ID_02', () => {
