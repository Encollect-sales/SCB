...
describe('UserManagement  First Name is blank, system will throw an error as "First Name is required"', () => {
    let loginPage;
    ...
    it('User download the agent template f First Name is blank, system will throw an error as "First Name is required" - TC_ID_01', () => {
