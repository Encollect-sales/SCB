...
describe('UserManagement -If user enters alphabets or special characters then system will throw an error as "Please enter Valid DRA Unique Registration Number."', () => {
    let loginPage;
    ...
    it('User download the agent template If user enters alphabets or special characters then system will throw an error as "Please enter Valid DRA Unique Registration Number." - TC_ID_02', () => {
