...
describe('UserManagement -If entered Department does not exist in db then system will throw an error as "Department is invalid"', () => {
    ...
    it('User download the agent template If entered Department does not exist in db then system will throw an error as "Department is invalid" - TC_ID_02', () => {
