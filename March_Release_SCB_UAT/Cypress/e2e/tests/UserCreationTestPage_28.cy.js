...
describe('UserManagement -If the TIN number is blank, then system will throw an error as "TIN number is Required"', () => {
    let loginPage;
    ...
    it('User download the agent template If the TIN number is blank, then system will throw an error as "TIN number is Required"- TC_ID_02', () => {
