...
describe('UserManagement -If user enters AgencyType more than 40 characters then system will throw an error as Agency Typecan not  be more than 40 characters', () => {
    let loginPage;
    ...
    it('User download the agent template If user enters AgencyType more than 40 characters then system will throw an error as Agency Typecan not  be more than 40 characters- TC_ID_02', () => {
        getTestData('loginData', 'login2').then(user => {
         ...
         //###########################################################################################################
            ...
            const data = {
                ...
                'D2': name,
                'E2': '4408',
                'F2': 'CollectionsCollectionsCollectionsCollectionsCollections',
                'G2': 'Field Agents',
                'H2': '12345321',
                'I2':'PANCA9614B',
                'J2':'hamad',
