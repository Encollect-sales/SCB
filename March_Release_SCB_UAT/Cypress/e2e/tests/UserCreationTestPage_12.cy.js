...
describe('UserManagement -If Department is blank, then system will throw an error as "Mob.No is Required"', () => {
    let loginPage;
    ...
    it('User download the agent template If phone number is blank, then system will throw an error as "Mob.No is Required" - TC_ID_02', () => {
