...
describe('UserManagement -If user enters alphabets or special character or numbers less than 6 digits then system will throw an error as "Enter valid 6 digit pincode"', () => {
    let loginPage;
    ...
    it('User download the agent template If user enters alphabets or special character or numbers less than 6 digits then system will throw an error as "Enter valid 6 digit pincode" - TC_ID_02', () => {
