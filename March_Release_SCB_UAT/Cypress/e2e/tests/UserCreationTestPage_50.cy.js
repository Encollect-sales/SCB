...
describe('UserManagement -If email id is blank then system will throw an error as "Email id is required', () => {
    let loginPage;
    ...
    it('If email id is blank then system will throw an error as "Email id is required" - TC_ID_50', () => {
