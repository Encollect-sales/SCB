...
describe('UserManagement -If Is Parent agency  is blank then system will throw an error as " Is Parent agency is required"', () => {
    let loginPage;
    ...
    it('User download the agent template If Is Parent agency  is blank then system will throw an error as " Is Parent agency is required" - TC_ID_02', () => {
