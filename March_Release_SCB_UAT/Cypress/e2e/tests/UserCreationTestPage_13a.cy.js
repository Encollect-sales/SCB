...
describe('UserManagement -If entered email is incorrect then system will throw an error as "Enter valid email"', () => {
    let loginPage;
    ...
    it('User download the agent template If entered email is incorrect then system will throw an error as "Enter valid email" - TC_ID_02', () => {
