...
describe('TC_343_POS - Verify Payments module is available', () => {
    let loginPage;
    ...
    it('Verify Payments module is available in the application menu', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
            receivableSearchPage.navigateToAccountDetails();
            receivableSearchPage.verifyPaymentsModuleAvailable();
        });
    });
});