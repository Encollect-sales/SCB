...
describe('TC_243_POS - Verify Communication ID column is displayed', () => {
    let loginPage;
    ...
    it('Verify Communication ID column is displayed', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
            receivableSearchPage.verifyCommunicationIdColumn();
        });
    });
});