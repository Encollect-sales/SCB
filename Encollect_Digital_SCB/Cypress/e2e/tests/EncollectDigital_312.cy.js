...
describe('TC_312_POS - Verify Product Information field mapping', () => {
    let loginPage;
    ...
    it('Verify fields are displayed based on mapping configuration', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
            receivableSearchPage.navigateToAccountDetails();
            receivableSearchPage.verifyProductInformationFieldMapping();
        });
    });
});