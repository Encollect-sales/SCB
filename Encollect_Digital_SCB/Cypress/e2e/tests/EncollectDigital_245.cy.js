...
describe('TC_245_POS - Verify Mobile Number column is displayed', () => {
    let loginPage;
    ...
    it('Verify Mobile Number column is displayed', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
            //receivableSearchPage.navigateToAccountDetails();
            receivableSearchPage.verifyCommunicationMobileNumberColumn();
        });
    });
});