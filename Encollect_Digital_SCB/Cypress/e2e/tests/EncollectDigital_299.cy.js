...
describe('TC_299_POS - Verify Show/Hide Empty Values toggle', () => {
    let loginPage;
    ...
    it('Verify Show/Hide Empty Values toggle is displayed', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
            receivableSearchPage.navigateToAccountDetails();
            receivableSearchPage.verifyFinancialDetailsShowHideEmptyValuesToggle();
        });
    });
});