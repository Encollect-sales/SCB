...
describe('ENCollect Digital - Geo Hierarchy Visualization', () => {
    ...
    it('TC_044_POS - Verify hierarchy visualization is displayed', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            mastersUploadPage.verifyGeoHierarchyVisualization();
