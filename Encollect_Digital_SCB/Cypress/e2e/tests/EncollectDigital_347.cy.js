...
describe('TC_347_POS - Verify access to Bulk Payments Upload Status screen', () => {
    let loginPage;
    ...
    it('Verify user can access Bulk Payments Upload Status screen', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
            receivableSearchPage.navigateToAccountDetails();
            receivableSearchPage.verifyBulkPaymentsUploadStatusScreen();
        });
    });
});