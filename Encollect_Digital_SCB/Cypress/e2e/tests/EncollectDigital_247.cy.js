...
describe('TC_247_POS - Verify Communication Template column is displayed', () => {
    let loginPage;
    ...
    it('Verify Communication Template column is displayed', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
            //receivableSearchPage.navigateToAccountDetails();
            receivableSearchPage.verifyCommunicationTemplateColumn();
        });
    });
});