...
describe('TC_191_POS - Online Payment Requests section', () => {
    let loginPage;
    ...
    it('Verify Online Payment Requests section is displayed', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
            accountDetailsPage.verifyNavigationToAccountDetails();
            accountDetailsPage.verifyOnlinePaymentRequestsSection();
        });
    });
});