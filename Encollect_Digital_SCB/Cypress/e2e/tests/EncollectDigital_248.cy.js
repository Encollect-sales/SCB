...
describe('TC_248_POS - Verify Communication Trigger column is displayed', () => {
    let loginPage;
    ...
    it('Verify Communication Trigger column is displayed', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
            //receivableSearchPage.navigateToAccountDetails();
            receivableSearchPage.verifyCommunicationTriggerColumn();
        });
    });
});