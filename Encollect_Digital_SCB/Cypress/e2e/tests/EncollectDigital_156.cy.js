...
describe('TC_156_POS - Verify default search fields are displayed', () => {
    let loginPage;
    ...
    it('Verify default search fields are displayed', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
            receivableSearchPage.verifyDefaultSearchFields();
        });
    });
});