...
describe('ENCollect Digital - Product Hierarchy Counts', () => {
    ...
    it('TC_031_POS - Verify ProductGroup, Product, SubProduct counts are displayed', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            mastersUploadPage.verifyProductHierarchyCounts();
