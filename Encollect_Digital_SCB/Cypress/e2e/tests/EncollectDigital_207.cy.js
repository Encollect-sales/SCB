...
describe('TC_207_POS - Verify Mode of Communication column', () => {
    let loginPage;
    ...
    it('Verify Mode of Communication column is displayed', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
            accountDetailsPage.navigateToAccountDetails();
            accountDetailsPage.verifyModeOfCommunicationColumnDisplayed();
        });
    });
});