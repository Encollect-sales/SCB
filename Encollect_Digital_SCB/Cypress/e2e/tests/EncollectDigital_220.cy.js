...
describe('TC_220_POS - Verify refresh icon functionality', () => {
    let loginPage;
    ...
    it('Verify Last 5 PTP data is refreshed successfully', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
            accountDetailsPage.navigateToAccountDetails();
            accountDetailsPage.verifyLast5PTPRefreshFunctionality();
        });
    });
});