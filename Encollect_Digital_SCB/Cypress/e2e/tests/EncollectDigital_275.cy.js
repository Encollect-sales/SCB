...
describe('TC_275_POS - Verify Payment History pagination', () => {
    let loginPage;
    ...
    it('Verify Payment History pagination functionality', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
            receivableSearchPage.navigateToAccountDetails();
            receivableSearchPage.verifyPaymentHistoryPagination();
        });
    });
});