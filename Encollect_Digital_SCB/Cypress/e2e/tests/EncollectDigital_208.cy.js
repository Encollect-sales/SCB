...
describe('TC_208_POS - Verify Disposition Code column', () => {
    let loginPage;
    ...
    it('Verify Disposition Code column is displayed', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
            accountDetailsPage.navigateToAccountDetails();
            accountDetailsPage.verifyDispositionCodeColumnDisplayed();
        });
    });
});