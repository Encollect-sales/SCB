...
describe('TC_154_POS - Verify Receivable Search menu is visible', () => {
    let loginPage;
    ...
    it('Verify Receivable Search menu is visible', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
            receivableSearchPage.verifyReceivableSearchMenuVisible();
        });
    });
});