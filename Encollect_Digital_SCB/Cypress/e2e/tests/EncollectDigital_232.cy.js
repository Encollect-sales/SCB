...
describe('TC_232_POS - Verify Collector Last Name column is displayed', () => {
    ...
    it('Verify Collector Last Name column is displayed', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);

            receivableSearchPage.verifyTrailHistoryCollectorLastName();
        });
    });
