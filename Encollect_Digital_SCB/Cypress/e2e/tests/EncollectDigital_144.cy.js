...
describe('TC_144_NEG - Verify template download failure', () => {
    let loginPage;
    ...
    it('Verify system behavior when template download fails', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
            receivableUploadPage.verifyTemplateDownloadFailure();
        });
    });
});