...
describe('TC_329_POS - Verify field labels are displayed correctly', () => {
    let loginPage;
    ...
    it('Verify field labels are displayed correctly', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
            receivableSearchPage.navigateToAccountDetails();
            receivableSearchPage.verifyAdditionalDetailsFieldLabels();
        });
    });
});