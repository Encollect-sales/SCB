...
describe('TC_279_POS - Verify Basic Information section is displayed', () => {
    let loginPage;
    ...
    it('Verify Basic Information section is displayed in Account Details screen', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
            receivableSearchPage.navigateToAccountDetails();
            receivableSearchPage.verifyBasicInformationSectionDisplayed();
        });
    });
});