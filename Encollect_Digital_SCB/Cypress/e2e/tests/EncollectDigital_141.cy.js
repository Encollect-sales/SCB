...
describe('TC_141_POS - Receivable Upload menus', () => {
    let loginPage;
    ...
    it('Verify Receivable Upload menu and submenus are visible', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
            receivableUploadPage.verifyReceivableUploadMenusVisible();
        });
    });
});