...
describe('TC_260_POS - Verify payment history records are displayed', () => {
    let loginPage;
    ...
    it('Verify payment history records are displayed in tabular format', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
            receivableSearchPage.navigateToAccountDetails();
            receivableSearchPage.verifyPaymentHistoryRecordsDisplayed();
        });
    });
});