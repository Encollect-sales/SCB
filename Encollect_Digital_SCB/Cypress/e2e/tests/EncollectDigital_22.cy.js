...
describe('ENCollect Digital - Bulk Upload Masters - File Upload Control', () => {
    ...
    it('TC_022_POS - Verify file upload control is present', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            // Verify file upload control
            mastersUploadPage.verifyFileUploadControl();
