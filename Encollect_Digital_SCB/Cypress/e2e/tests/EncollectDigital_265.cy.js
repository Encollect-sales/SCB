...
describe('TC_265_POS - Verify Instrument Number column', () => {
    let loginPage;
    ...
    it('Verify Instrument Number column is displayed', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
            receivableSearchPage.navigateToAccountDetails();
            receivableSearchPage.verifyInstrumentNumberColumnDisplayed();
        });
    });
});