...
describe('TC_330_POS - Verify field values are displayed correctly', () => {
    let loginPage;
    ...
    it('Verify field values are displayed correctly', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
            receivableSearchPage.navigateToAccountDetails();
            receivableSearchPage.verifyAdditionalDetailsFieldValues();
        });
    });
});