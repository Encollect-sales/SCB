...
describe('TC_238_POS - Verify settings gear icon displays available fields', () => {
    let loginPage;
    ...
    it('Verify settings gear icon displays available fields', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
            receivableSearchPage.verifyTrailHistorySettingsFields();
        });
    });
});