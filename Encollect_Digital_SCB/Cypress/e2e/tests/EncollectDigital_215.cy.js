...
describe('TC_215_POS - Verify Uploaded File Name column', () => {
    let loginPage;
    ...
    it('Verify Uploaded File Name column is displayed', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
            accountDetailsPage.navigateToAccountDetails();
            accountDetailsPage.verifyUploadedFileNameColumnDisplayed();
        });
    });
});