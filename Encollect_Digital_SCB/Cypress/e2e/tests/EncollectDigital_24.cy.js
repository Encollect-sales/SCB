...
describe('ENCollect Digital - Bulk Upload Masters - Upload Button', () => {
    ...
    it('TC_024_POS - Verify upload button is enabled after file selection', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            // Select valid file
            mastersUploadPage.selectFile('BankMasterTemplate.xlsx');

            // Verify Upload button is enabled
            mastersUploadPage.verifyUploadButtonEnabled();
