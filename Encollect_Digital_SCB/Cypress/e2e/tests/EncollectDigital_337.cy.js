...
describe('TC_337_POS - Verify Add PTP option is available', () => {
    let loginPage;
    ...
    it('Verify Add PTP option is available in action menu', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
            receivableSearchPage.navigateToAccountDetails();
            receivableSearchPage.verifyAdditionalDetailsAddPTPOption();
        });
    });
});