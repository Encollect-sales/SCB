...
describe('ENCollect Digital - Bulk Upload Masters - Upload Without File', () => {
    ...
    it('TC_025_NEG - Verify upload button behavior without file selection', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            mastersUploadPage.verifyUploadButtonDisabled();
