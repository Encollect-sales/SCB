...
describe('TC_295_POS - Verify Financial Details section is displayed', () => {
    let loginPage;
    ...
    it('Verify Financial Details section is displayed in Account Details screen', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
            receivableSearchPage.navigateToAccountDetails();
            receivableSearchPage.verifyFinancialDetailsSectionDisplayed();
        });
    });
});