...
describe('TC_327_POS - Verify Additional Details section', () => {
    let loginPage;
    ...
    it('Verify Additional Details section is displayed', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
            receivableSearchPage.navigateToAccountDetails();
            receivableSearchPage.verifyAdditionalDetailsSectionDisplayed();
        });
    });
});