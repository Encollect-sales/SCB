...
describe('TC_236_POS - Verify refresh icon is displayed and functional', () => {
    let loginPage;
    ...
    it('Verify refresh icon is displayed and functional', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
            receivableSearchPage.verifyTrailHistoryRefreshIcon();
        });
    });
});