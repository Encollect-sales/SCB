...
describe('TC_296_POS - Verify Financial Details field mapping', () => {
    let loginPage;
    ...
    it('Verify fields are displayed based on Field-to-Section mapping configuration', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
            receivableSearchPage.navigateToAccountDetails();
            receivableSearchPage.verifyFinancialDetailsFieldsMapping();
        });
    });
});