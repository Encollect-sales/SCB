...
describe('TC_123_POS - Navigate to Design Digital Strategy', () => {
    let loginPage;
    ...
    it('Verify user can navigate to Design Digital Strategy', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
            collectionStrategyPage.navigateToDesignDigitalStrategy();
        });
    });
});