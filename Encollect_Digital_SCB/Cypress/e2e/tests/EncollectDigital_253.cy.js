...
describe('TC_253_POS - Verify Add Trail button functionality', () => {
    let loginPage;
    ...
    it('Verify Add Trail button functionality', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
            //receivableSearchPage.navigateToAccountDetails();
            receivableSearchPage.verifyCommunicationAddTrailFunctionality();
        });
    });
});