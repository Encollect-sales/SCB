...
describe('ENCollect Digital - Product Hierarchy Child Nodes', () => {
    ...
    it('TC_034_POS - Verify child nodes under Product are displayed', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            mastersUploadPage.verifyProductChildNodes();
