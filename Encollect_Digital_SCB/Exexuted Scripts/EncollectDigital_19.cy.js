...
describe('ENCollect Digital - Bulk Upload Masters - Download Template Section', () => {
    ...
    it('TC_019_POS - Verify Download Template section is visible', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            // Verify Download Template section
            mastersUploadPage.verifyDownloadTemplateSection();
