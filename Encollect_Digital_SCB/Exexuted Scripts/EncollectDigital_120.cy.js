...
describe('TC_120_POS - Digital Campaign Runs submenu', () => {
    let loginPage;
    ...
    it('Verify Digital Campaign Runs submenu is visible', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
            collectionStrategyPage.verifyDigitalCampaignRunsVisible();
        });
    });
});