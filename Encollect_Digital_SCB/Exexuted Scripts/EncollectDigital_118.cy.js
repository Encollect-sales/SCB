...
describe('TC_118_POS - Set up Digital Campaign submenu', () => {
    let loginPage;
    ...
    it('Verify Set up Digital Campaign submenu is visible', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
            collectionStrategyPage.verifySetUpDigitalCampaignVisible();
        });
    });
});