...
describe('ENCollect Digital - Geo Hierarchy Navigation', () => {
    ...
    it('TC_052_POS - Verify navigation from sidebar to Geo Hierarchy', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            mastersUploadPage.verifyGeoHierarchyNavigation();
