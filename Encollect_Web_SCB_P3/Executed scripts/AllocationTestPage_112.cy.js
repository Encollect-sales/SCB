...
describe('Allocation - User should select appropriate radio button while uploading the allocation file.', () => {
    let loginPage;
    let allocationpage;
    ...
    it('Allocation Module - TC_ID_112', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
                cy.wait(900);
                allocationpage.AllocationTestPage_112_download();
                ...
                allocationpage.AllocationTestPage_112_upload();   
            });
        });
    });