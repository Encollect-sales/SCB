...
describe('System Setting - Master Upload', () => {
    ...
    it('Base Branch Master - TC_ID_1137 - Admin to Upload Product Master file from frontend by clicking on system setting>>Bulk Upload Of Master>>Upload Master file', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
                cy.wait(900);
                systemsettingPage.systemSettingModule();
                systemsettingPage.BaseBranchMaster1137();
