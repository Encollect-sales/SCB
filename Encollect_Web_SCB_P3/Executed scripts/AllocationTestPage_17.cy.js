...
describe('Allocation - Logged in user to click on customer id level sub menu to download the template of allocation owner.', () => {
    let loginPage;
    let allocationpage;
    ...
    it('Allocation Module - TC_ID_17', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
                cy.wait(900);
                allocationpage.AllocationTestPage_17_download();
                ...
                allocationpage.AllocationTestPage_17_upload();   
            });
        });
    });