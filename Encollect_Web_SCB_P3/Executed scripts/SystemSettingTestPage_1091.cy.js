...
describe('System Setting - Master Upload - Admin should be able to open the downloaded file and update the product master data accordingly.', () => {
    let loginPage;
    ...
    it('Master Upload- TC_ID_1091', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
                cy.wait(900);
                systemsettingpage.SystemSettingTestPage_1091();
