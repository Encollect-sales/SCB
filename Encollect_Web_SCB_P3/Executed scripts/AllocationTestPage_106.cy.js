...
describe('Allocation - Addition of customer id column in the output files of all primary unallocated files.', () => {
    let loginPage;
    let allocationpage;
    ...
    it('Allocation Module - TC_ID_106', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
                cy.wait(900);
                allocationpage.AllocationTestPage_106_download();
                ...
                allocationpage.AllocationTestPage_106_upload();   
            });
        });
    });