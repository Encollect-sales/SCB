...
describe('Allocation - User should select appropriate radio button while uploading the unallocation file.', () => {
    let loginPage;
    let allocationpage;
    ...
    it('Allocation Module - TC_ID_105', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
                cy.wait(900);
                allocationpage.AllocationTestPage_105_download();
                ...
                allocationpage.AllocationTestPage_105_upload();   
            });
        });
    });