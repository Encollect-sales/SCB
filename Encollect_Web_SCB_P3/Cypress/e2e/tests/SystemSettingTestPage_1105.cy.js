...
describe('System Setting - Master Upload -The sequence of fields in the standard product master file should exactly match in the db.', () => {
    let loginPage;
    ...
    it('Master Upload- TC_ID_1105-  An email will trigger on Admin email id with an attachment', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
                cy.wait(900);
                systemsettingpage.SystemSettingTestPage_1105();
