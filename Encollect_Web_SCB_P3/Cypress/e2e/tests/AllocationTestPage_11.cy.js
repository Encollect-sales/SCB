...
describe('Allocation - QA to validate the customer id which exist in db or not or else encollect system will throw an error.', () => {
    let loginPage;
    let allocationpage;
    ...
    it('Allocation Module - TC_ID_11', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
                cy.wait(900);
                allocationpage.AllocationTestPage_11_download();
                ...
                allocationpage.AllocationTestPage_11_upload();   
            });
        });
    });