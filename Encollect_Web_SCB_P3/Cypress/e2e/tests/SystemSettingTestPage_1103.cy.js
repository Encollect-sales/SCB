...
describe('System Setting - Master Upload -The records which got failed to upload from fe, all those records to be stored in intermediateerrortable initially and should move to intermediateerrortable_archive permanently', () => {
    let loginPage;
    ...
    it('Master Upload- TC_ID_1103-  intermediateerrortable_archive is maintained to store all historical failed records.', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
                cy.wait(900);
                systemsettingpage.SystemSettingTestPage_1103();
