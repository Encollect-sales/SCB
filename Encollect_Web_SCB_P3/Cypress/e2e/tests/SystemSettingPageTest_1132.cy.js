...
describe('System Setting - Master Upload', () => {
    ...
    it('Bucket Master - TC_ID_1132 - Admin downloaded the standard bucket master file and entered 10 records of current bucket and uploaded the file back to ENCollect', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
                cy.wait(900);
                systemsettingPage.BucketMaster1132();
