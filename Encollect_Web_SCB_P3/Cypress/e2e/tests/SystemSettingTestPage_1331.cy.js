...
describe('System Setting - Master Upload - Admin downloaded the standard bank master file and entered 500 records of bank name, branch name and branch code and uploaded the file back to ENCollect', () => {
    let loginPage;
    ...
    it('Master Upload- TC_ID_1331', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
                cy.wait(900);
                systemsettingpage.SystemSettingTestPage_1331();
