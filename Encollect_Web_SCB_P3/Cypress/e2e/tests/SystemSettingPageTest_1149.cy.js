...
describe('System Setting - Master Upload', () => {
    ...
    it('Base Branch Master - TC_ID_1149 - The sequence of fields in the standard base branch master file should exactly match in the db.', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
                cy.wait(900);
                systemsettingPage.systemSettingModule();
                systemsettingPage.BaseBranchMaster1149();
