...
describe('System Setting - Master Upload - Admin uploaded Product master file with 10 records but for 5 records product  is not updated.', () => {
    let loginPage;
    ...
    it('Master Upload- TC_ID_1097-  An email will trigger on admin email id with an attachment.', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
                cy.wait(800);
                systemsettingpage.SystemSettingTestPage_1097();
