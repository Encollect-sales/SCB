...
describe('Allocation - Addition of customer id column in the output files of all secondary allocated files.', () => {
    let loginPage;
    let allocationpage;
    ...
    it('Allocation Module - TC_ID_13', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
                cy.wait(900);
                allocationpage.AllocationTestPage_13_download();
                ...
                allocationpage.AllocationTestPage_13_upload();   
            });
        });
    });