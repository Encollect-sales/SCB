...
describe('System Setting - Bank Master -Admin uploaded bank master file with 10 records but for 5 records branch code  is not updated.', () => {
    let loginPage;
    ...
    it('Master Upload- TC_ID_1312- All failed records should move to intermediateerrortable.".', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
                cy.wait(900);
                systemsettingpage.SystemSettingTestPage_1312();
