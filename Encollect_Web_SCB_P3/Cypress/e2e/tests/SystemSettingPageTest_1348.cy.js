...
describe('System Setting - Master Upload', () => {
    ...
    it('Deposit Bank Master - TC_ID_1348 - Admin while uploading the deposit bank master file into ENCollect should not change the file extension(i.e.xlsx).', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
                cy.wait(900);
                systemsettingPage.systemSettingModule();
                systemsettingPage.DepositeBankMaster1348();
