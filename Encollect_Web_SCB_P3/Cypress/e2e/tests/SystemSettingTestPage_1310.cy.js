...
describe('System Setting - Bank Master -Admin uploaded bank master file with 10 records but for 5 records bank name is not updated.', () => {
    let loginPage;
    ...
    it('Master Upload- TC_ID_1310- An email will trigger on admin email id with an attachment.".', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
                cy.wait(900);
                systemsettingpage.SystemSettingTestPage_1310();
