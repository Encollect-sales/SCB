...
describe('System Setting - Master Upload', () => {
    ...
    it('Base Branch Master - TC_ID_1148 - Admin while uploading the base branch master file into ENCollect should not change the file extension(i.e.xlsx).', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
                cy.wait(900);
                systemsettingPage.systemSettingModule();
                systemsettingPage.BaseBranchMaster1148();
