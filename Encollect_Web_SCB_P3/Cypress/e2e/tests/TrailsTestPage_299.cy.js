...
describe('Trails - Bulk trail upload  -', () => {
    ...
    it('User download the bulktrail template and make updates in the excel sheet and user upload the updated excel sheet - TC_ID_299', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
            cy.wait(900);
            trailspage.TrailsTestPage_download_299();
            ...
            const data = {
                ...
                trailspage.TrailsTestPage_upload_299();
            });
        });
    });
