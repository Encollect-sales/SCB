...
describe('System Setting - Master Upload', () => {
    ...
    it('Bucket Master - TC_ID_1126 - Admin downloaded the standard bucket master file but did not entered any data and uploaded the file back to ENCollect', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
                cy.wait(900);
                systemsettingPage.systemSettingModule();
                systemsettingPage.BucketMaster1126();
