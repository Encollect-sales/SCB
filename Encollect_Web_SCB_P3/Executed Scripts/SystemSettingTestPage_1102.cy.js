...
describe('System Setting -Upload Master - Admin downloaded the standard product master file but did not entered any data and uploaded the file back to ENCollect', () => {
    let loginPage;
    ...
    it('Master Upload- TC_ID_1102', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
                cy.wait(900);
                systemsettingpage.SystemSettingTestPage_1102();
