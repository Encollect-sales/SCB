...
describe('Credit Card - Account Aggregator - Verify Success Message Content', () => {
    ...
    it('TC_083 - Credit Card - Verify success message content', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            accountAggregatorPage.VerifySuccessMessageContent();
