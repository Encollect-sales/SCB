...
describe('Trail History Report - Verify Disposition fields are not mandatory - Agencystaff', () => {
    ...
    it('TC_010 - Verify UI shows Disposition filters but does not enforce them - Agencystaff', () => {
