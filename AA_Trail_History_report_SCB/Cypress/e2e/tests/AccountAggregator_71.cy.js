...
describe('Credit Card - Account Aggregator - Verify Account Number Masking', () => {
    ...
    it('TC_071 - Credit Card - Verify Account Number is masked', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            accountAggregatorPage.VerifyMaskedAccountNumber();
