...
describe('Credit Card - Account Aggregator - Verify Bank Name Display', () => {
    ...
    it('TC_069 - Credit Card - Verify Bank Name is displayed', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            accountAggregatorPage.VerifyBankName();
