...
describe('Credit Card - Account Aggregator - Verify How To Use Instructions', () => {
    ...
    it('TC_064 - Credit Card - Verify "How to Use" instructions are displayed', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            accountAggregatorPage.VerifyHowToUseSection();
