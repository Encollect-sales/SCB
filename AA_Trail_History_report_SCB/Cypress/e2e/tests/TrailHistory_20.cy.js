...
describe('Trail History Report - Verify Disposition Code Group filter is visible - Agencystaff', () => {
    ...
    it('TC_002 - Verify Disposition Code Group filter is visible - Agencystaff', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            trailHistoryReportPage.verifyDispositionCodeGroupVisible();
