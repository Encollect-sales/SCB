...
describe('Credit Card - Account Aggregator - Verify Eye Icon Functionality', () => {
    ...
    it('TC_072 - Credit Card - Verify eye icon functionality for Account Number', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            accountAggregatorPage.VerifyEyeIcon();
