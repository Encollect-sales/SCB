...
describe('Account Aggregator - Verify Current Balance Currency Symbol', () => {
    ...
    it('TC_036 - Verify Current Balance is displayed with currency symbol', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            accountAggregatorPage.VerifyCurrencySymbol();
