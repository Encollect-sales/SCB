...
describe('Account Aggregator - Verify Account Aggregator Configuration', () => {
    ...
    it('TC_003 - Verify Account Aggregator is configurable in Product', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            accountAggregatorPage.VerifyAccountAggregatorConfiguration();
