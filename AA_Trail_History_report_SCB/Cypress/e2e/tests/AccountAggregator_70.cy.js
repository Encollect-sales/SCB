...
describe('Credit Card - Account Aggregator - Verify Account Number is Displayed', () => {
    ...
    it('TC_070 - Credit Card - Verify Account Number is displayed in Bank Details Grid', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            accountAggregatorPage.VerifyAccountNumberDisplayed();
