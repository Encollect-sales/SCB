...
describe('Trail History Report - Verify download using only PBG and Trail Date Range', () => {
    ...
    it('TC_006 - Verify user can download report using only PBG + Trail Date Range', () => {
