...
describe('Credit Card - Account Aggregator - Verify No Duplicate Account Aggregator Option', () => {
    ...
    it('TC_063 - Credit Card - Verify Account Aggregator option is displayed only once', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            accountAggregatorPage.VerifyNoDuplicateAccountAggregator();
