...
describe('Credit Card - Account Aggregator - Verify Current Balance Currency Symbol', () => {
    ...
    it('TC_075 - Credit Card - Verify Current Balance is displayed with currency symbol', () => {
