...
describe('Trail History Report - Verify Disposition Code Group is NOT mandatory - Agencystaff', () => {
    ...
    it('TC_004 - Verify Disposition Code Group is NOT mandatory - Agencystaff', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            trailHistoryReportPage.verifyNoDispositionValidation();
            cy.wait(5000);
