...
describe('Credit Card - Account Aggregator - Verify Multiple Clicks on View Bank Balance', () => {
    ...
    it('TC_081 - Credit Card - Verify multiple clicks do not trigger multiple requests', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            accountAggregatorPage.VerifyMultipleClicksOnViewBankBalance();
