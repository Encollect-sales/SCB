...
describe('Credit Card - Account Aggregator - Verify Loading Indicator', () => {
    ...
    it('TC_077 - Credit Card - Verify loading indicator is displayed after clicking View Bank Balance', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            accountAggregatorPage.VerifyLoaderDisplayed();
