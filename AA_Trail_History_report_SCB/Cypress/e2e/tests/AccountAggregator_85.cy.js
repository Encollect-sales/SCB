...
describe('Credit Card - Account Aggregator - Verify No Duplicate Success Messages', () => {
    ...
    it('TC_085 - Credit Card - Verify success message is displayed only once', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            accountAggregatorPage.VerifySingleSuccessToast();
