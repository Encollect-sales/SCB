...
describe('Credit Card - Account Aggregator - Verify Account Aggregator Option is Clickable', () => {
    ...
    it('TC_060 - Credit Card - Verify Account Aggregator option is clickable', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            accountAggregatorPage.VerifyAccountAggregatorPage();
