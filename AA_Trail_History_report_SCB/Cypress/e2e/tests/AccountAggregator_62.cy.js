...
describe('Credit Card - Account Aggregator - Verify Label Name of Account Aggregator', () => {
    ...
    it('TC_062 - Credit Card - Verify label name of Account Aggregator', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            accountAggregatorPage.VerifyAccountAggregatorLabel();
