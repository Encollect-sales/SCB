...
describe('Trails - Action Code – Mandatory Field Validation ', () => {
    let loginPage;
    let trailspage;
    ...
    it('This is a negative test case to verify that the Action Code field is mandatory. The test ensures that when the Action Code is left empty, the system fails the record and does not process it during Trail creation or Bulk Trail Upload.', () => {
