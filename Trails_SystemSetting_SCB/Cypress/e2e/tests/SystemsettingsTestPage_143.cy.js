...
describe('Deposit Bank Master - Negative Test - Upload file with invalid data type in a field', () => {
  ...
  it('Negative Test - Upload file with invalid data type in a field', () => {
    getTestData('loginData', 'login2').then(user => {
      ...
      cy.wait(1000);
      systemSettingsPage.Systemsettings_BulkMasters_deposit_branch_master_11();
    });
  });
