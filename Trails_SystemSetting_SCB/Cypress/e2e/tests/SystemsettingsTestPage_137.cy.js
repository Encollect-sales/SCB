...
describe('Base Branch Master - Negative Test - Upload mismatched master data under wrong template', () => {
  ...
  it('Negative Test - Upload mismatched master data under wrong template', () => {
    getTestData('loginData', 'login2').then(user => {
      ...
      cy.wait(1000);
      systemSettingsPage.Systemsettings_BulkMasters_base_branch_master_13();
    });
  });
