...
describe('Trails - RightPartyContact Left Empty', () => {
    let loginPage;
    let trailspage;
    ...
    it('Verify system validation when the RightPartyContact field is left blank during Trail creation or Bulk Trail Upload.', () => {
