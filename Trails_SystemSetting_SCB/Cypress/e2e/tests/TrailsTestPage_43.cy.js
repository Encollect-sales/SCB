...
describe('Trails - Entering Past date in Next Action Date column ', () => {
    let loginPage;
    let trailspage;
    ...
    it('This is a negative test case to verify that the system rejects a past date entered in the Next Action Date field.', () => {
