...
describe('Trails - Agent ENCollect Code with Special Characters ', () => {
    let loginPage;
    let trailspage;
    ...
    it('Verify that the system rejects the Agent ENCollect Code when it contains special characters (e.g., @, #, $, %), ensuring only valid formats are accepted.', () => {
