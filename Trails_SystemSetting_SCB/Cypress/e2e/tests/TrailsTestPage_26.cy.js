...
describe('Trails - Verify validation when an invalid Agreement ID is entered. ', () => {
    let loginPage;
    let trailspage;
    ...
    it('The system should reject the invalid Agreement ID and display an appropriate validation error message. The Trail record should not be created or processed.', () => {
