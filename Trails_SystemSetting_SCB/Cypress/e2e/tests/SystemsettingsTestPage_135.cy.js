...
describe('Base Branch Master - Negative Test - Upload file with invalid data type in a field', () => {
  ...
  it('Negative Test - Upload file with invalid data type in a field', () => {
    getTestData('loginData', 'login2').then(user => {
      ...
      cy.wait(1000);
      systemSettingsPage.Systemsettings_BulkMasters_base_branch_master_11();
    });
  });
