...
describe('Trails - Leaving Agreement id column empty ', () => {
    let loginPage;
    let trailspage;
    ...
    it('To verify that when the Agreement ID column is left empty in the Bulk Trail upload file, the system identifies the missing value, marks the record as failed, and displays an appropriate validation error message without processing the invalid entry.', () => {
