...
describe('Trails - Agent ENCollect Code Left Empty ', () => {
    let loginPage;
    let trailspage;
    ...
    it('Verify system validation when the Agent ENCollect Code field is left blank during Trail creation or Bulk Trail Upload.', () => {
