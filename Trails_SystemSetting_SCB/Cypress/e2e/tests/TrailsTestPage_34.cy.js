...
describe('Trails - RightPartyContact with Special Characters', () => {
    let loginPage;
    let trailspage;
    ...
    it('Verify that the system rejects RightPartyContact values containing special characters (e.g., @, #, $, %, !), ensuring only valid characters are allowed.', () => {
