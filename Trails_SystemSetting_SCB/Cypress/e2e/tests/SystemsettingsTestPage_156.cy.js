...
describe('Bucket Master - Negative Test - Validate exact error/toast message text on failure', () => {
  ...
  it('Negative Test - Validate exact error/toast message text on failure', () => {
    getTestData('loginData', 'login2').then(user => {
      ...
      cy.wait(1000);
      systemSettingsPage.Systemsettings_BulkMasters_Bucket_branch_master_16();
    });
  });
