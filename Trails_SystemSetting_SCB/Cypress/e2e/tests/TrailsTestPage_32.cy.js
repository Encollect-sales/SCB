...
describe('Trails - Wrong / Invalid Agent ENCollect Code ', () => {
    let loginPage;
    let trailspage;
    ...
    it('Verify system behavior when an invalid or non-existing Agent ENCollect Code is provided in the input or bulk upload file.', () => {
