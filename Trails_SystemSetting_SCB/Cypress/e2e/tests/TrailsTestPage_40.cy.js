...
describe('Trails - ResultCode with Special Characters', () => {
    let loginPage;
    let trailspage;
    ...
    it('This is a negative test case to verify that the system rejects ResultCode values containing special characters (e.g., @, #, $, %).', () => {
