...
describe('Disposition Master - Negative Test - Validate exact error/toast message text on failure', () => {
  ...
  it('Negative Test - Validate exact error/toast message text on failure', () => {
    getTestData('loginData', 'login2').then(user => {
      ...
      cy.wait(1000);
      systemSettingsPage.Systemsettings_BulkMasters_Disposition_master_16();
    });
  });
