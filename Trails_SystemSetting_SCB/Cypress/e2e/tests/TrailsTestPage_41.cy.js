...
describe('Trails - ResultCode with Invalid / Wrong Value', () => {
    let loginPage;
    let trailspage;
    ...
    it('This is a negative test case to verify system behavior when an invalid or non-configured ResultCode is entered.', () => {
