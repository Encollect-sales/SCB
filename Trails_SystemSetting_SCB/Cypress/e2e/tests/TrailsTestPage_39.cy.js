...
describe('Trails - ResultCode Left Empty', () => {
    let loginPage;
    let trailspage;
    ...
    it('This is a negative test case to verify that the system validates the ResultCode field when it is left blank during Trail creation or Bulk Trail Upload.', () => {
