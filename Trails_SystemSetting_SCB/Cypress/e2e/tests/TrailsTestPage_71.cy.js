...
describe('Trails - Re-upload same file while previous upload is processing ', () => {
    let loginPage;
    let trailspage;
    ...
    it('Verify system behavior when same Bulktrail file is re-uploaded during processing', () => {
        getTestData('loginData', 'login2').then(user => {
         ...
         const address = faker.location.streetAddress();
            ...
            const data = {
                ...
                trailspage.Bulktrail_Reupload_While_Processing();
            });
        });
    });
