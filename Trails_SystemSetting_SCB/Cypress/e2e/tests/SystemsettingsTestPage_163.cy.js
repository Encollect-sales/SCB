...
describe('Disposition Master - Negative Test - Upload unsupported file extension (.csv/.txt)', () => {
  ...
  it('Negative Test - Upload unsupported file extension (.csv/.txt)', () => {
    getTestData('loginData', 'login2').then(user => {
      ...
      cy.wait(1000);
      systemSettingsPage.Systemsettings_BulkMasters_Disposition_master_15();
    });
  });
