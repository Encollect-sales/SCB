...
describe('Trails - Action Code with Wrong / Invalid Value', () => {
    let loginPage;
    let trailspage;
    ...
    it('This is a negative test case to verify system behavior when a wrong or invalid value is entered in the Status Code field. The test ensures that values not supported or not configured in the system are properly rejected.', () => {
