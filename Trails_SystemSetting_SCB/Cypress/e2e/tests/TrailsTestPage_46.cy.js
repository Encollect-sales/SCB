...
describe('Trails - PTP Amount Left Empty', () => {
    let loginPage;
    let trailspage;
    ...
    it('This is a negative test case to verify validation when the PTP Amount field is left empty while the Action Code is PTP.', () => {
