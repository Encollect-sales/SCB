...
describe('Trails - RightPartyContact with Alphanumeric Value', () => {
    let loginPage;
    let trailspage;
    ...
    it('Verify that the system correctly accepts RightPartyContact values containing a combination of alphabets and numbers, as per business requirements.', () => {
