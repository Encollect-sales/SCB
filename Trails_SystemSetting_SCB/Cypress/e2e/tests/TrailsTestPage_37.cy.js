...
describe('Trails - Action Code column with Special Characters', () => {
    let loginPage;
    let trailspage;
    ...
    it('This is a negative test case to verify system behavior when special characters are entered in the Status Code field. The test ensures that invalid values are properly validated and the record is not processed.', () => {
