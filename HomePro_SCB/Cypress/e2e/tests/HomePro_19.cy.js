...
describe('HomePro - Verify search can be performed using Property City only', () => {
    ...
    it('TC_029 - Verify search can be performed using Property City only', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            homeProPage.SearchByPropertyCity();
