...
describe('HomePro - Verify imported Property City value is searchable', () => {
    ...
    it('TC_043 - Verify imported Property City value is searchable', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            homeProPage.SearchImportedPropertyCity();
