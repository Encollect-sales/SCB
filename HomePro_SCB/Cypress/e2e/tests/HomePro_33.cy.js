...
describe('HomePro - Verify imported Branch Name value is searchable', () => {
    ...
    it('TC_046 - Verify imported Branch Name value is searchable', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            homeProPage.SearchImportedBranchName();
