...
describe('HomePro - Verify search can be performed using Property Name only', () => {
    ...
    it('TC_030 - Verify search can be performed using Property Name only', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            homeProPage.SearchByPropertyName();
