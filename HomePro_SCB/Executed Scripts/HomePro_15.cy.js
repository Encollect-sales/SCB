...
describe('HomePro - Verify search can be performed using Builder Name only', () => {
    ...
    it('TC_031 - Verify search can be performed using Builder Name only', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            homeProPage.SearchByBuilderName();
