...
describe('HomePro - Verify imported Property Name value is searchable', () => {
    ...
    it('TC_044 - Verify imported Property Name value is searchable', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            homeProPage.SearchImportedPropertyName();
