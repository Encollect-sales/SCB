...
describe('HomePro - Verify imported Builder Name value is searchable', () => {
    ...
    it('TC_045 - Verify imported Builder Name value is searchable', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            homeProPage.SearchImportedBuilderName();
