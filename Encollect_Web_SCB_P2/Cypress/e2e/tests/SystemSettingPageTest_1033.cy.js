...
describe('System Setting - Account Import Via Front End Bulk Upload (Loans)', () => {
    ...
    it('System Setting - TC_ID_1033 - Admin to upload Account import file from frontend by clicking on System setting >>Account import master>>Upload Account import master(Next Day)', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
                cy.wait(5000);
                systemsettingPage.Systemsetting1033();
                //loginPage.logout();
