...
describe('User Management - Local Address Details', () => {
    ...
    it('Agent Empanelment Request - TC_ID_894 - 1.User clicked on Fathers Name field but did not enter any value then system should show an error. ', () => {
        getTestData('loginData', 'login').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
                cy.wait(12000);
                userManagementPage.UserManagementModule();
                userManagementPage.LocalAddDetailils894();
                //loginPage.logout();
