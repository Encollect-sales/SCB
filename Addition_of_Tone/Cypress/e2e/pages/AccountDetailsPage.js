...
class AccountDetailsPage {
  ...
  AccountSearch238() {
    ...
    // cy.wait(1000);
    cy.wait(500);
    cy.get(this.locators.csname).type('ANITA', { force: true });
    cy.wait(500)
  ...
  ViewAccountDetailsPageTest_248() {
    ...
    cy.wait(200);
    cy.get(this.locators.dc).select("Broken Promise To Pay");
    cy.wait(200);
  ...
  AllocationHistoryPageTest_544() {
    ...
    cy.get("#search-account-number").type('Test123456', { force: true });
    cy.wait(2000);
  ...
  //  cy.get('.ng-arrow-wrapper').click();
    ...
    // cy.wait(500);
    // Interaction Part 1: Typing and Clicking
    cy.get('#search-customer-name').type('ANITA', { force: true });
    cy.wait(500);
  ...
  AccountDetailsTestPage_95() {
    ...
    cy.wait(7000);
    cy.get('tbody > :nth-child(1) > :nth-child(4) > a > a').click();
    cy.wait(7000);
  ...
  ViewAccountDetails008() {
    ...
    cy.get('#sendPaymentLink > .dropdown-item').click();
    cy.wait(1000);
    cy.contains('airpay').should('be.visible');
    cy.wait(1000);
  ...
  ViewAccountDetails010() {
    ...
    cy.get('#sendPaymentLink > .dropdown-item').click();
    cy.wait(1000);
    cy.get('.form-control-group .form-radio-group.vertical').click();
