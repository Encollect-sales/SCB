...
describe('SignalR Notification - Verify "Close" button functionality in confirmation popup', () => {
    ...
    it('SignalR Notification - TC_39', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            .then(() => {
                ...
                notificationPage.SignalRNotification_39(excelFileName);
