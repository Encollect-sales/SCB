...
describe('Legal Bulk Upload - Invalid Upload Type Validation', () => {
    ...
    it('TC_010 - Verify upload fails when an invalid Upload Type is entered', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const data = {
                ...
                'C2': partyName,
                'D2': 'Father',
                'E2': 'UpdateData',          // Invalid Upload Type
