...
describe('Legal Bulk Upload - WhatsApp Delivery Status Maximum Length Validation', () => {
    ...
    it('TC_045 - Verify upload fails when WhatsApp Delivery Status exceeds maximum length', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const data = {
                ...
                // WhatsApp Delivery Status exceeds max length
                'J2': faker.string.alphanumeric(51),
