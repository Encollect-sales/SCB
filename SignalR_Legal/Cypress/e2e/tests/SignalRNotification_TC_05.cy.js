...
describe('SignalR Notification - Verify toggle functionality when no notifications exist', () => {
    ...
    it('SignalR Notification - TC_05', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            notificationPage.SignalRNotification_05();
