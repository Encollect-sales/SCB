...
describe('Legal Bulk Upload - Notice Reference Number Max Length Validation', () => {
    ...
    it('TC_016 - Verify upload fails when Notice Reference Number exceeds maximum length', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const noticeReferenceNo = faker.string.alphanumeric(150);
