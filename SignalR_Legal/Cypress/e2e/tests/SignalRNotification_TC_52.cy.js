...
describe('SignalR Notification - Verify notification triggered only after successful action', () => {
    ...
    it('SignalR Notification - TC_52', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            notificationPage.SignalRNotification_52();
