...
describe('Legal Bulk Upload - Tracking ID Maximum Length Validation', () => {
    ...
    it('TC_065 - Verify upload fails when Tracking ID exceeds maximum length', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const data = {
                ...
                // Tracking ID exceeds maximum length
