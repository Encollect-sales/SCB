...
describe('SignalR Notification - Verify error notification is listed in notification panel', () => {
  ...
  // Download template
            ...
            .then((result) => {
                ...
                notificationPage.uploadFile(excelFileName);
                 notificationPage.SignalRNotification_78();
