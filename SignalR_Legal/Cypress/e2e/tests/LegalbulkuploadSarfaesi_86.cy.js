...
describe('Legal Bulk Upload - Sarfaesi Status Contains Only Whitespace Validation', () => {
    ...
    it('TC_086 - Verify upload fails when Sarfaesi Status contains only whitespace', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const data = {
                ...
                // Sarfaesi Status contains only whitespace
                'G2': '     ',
