...
describe('Legal Bulk Upload - Physical Tracking ID Maximum Length Validation', () => {
    ...
    it('TC_036 - Verify upload fails when Physical Tracking ID exceeds maximum length', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const data = {
                ...
                // Physical Tracking ID exceeds maximum length
                'P2': faker.string.alphanumeric(101)
            ...
            legalPage.VerifyLegalDetailsNotExists({
                ...
                noticeReferenceNo,
                trackingId: faker.string.alphanumeric(101)
