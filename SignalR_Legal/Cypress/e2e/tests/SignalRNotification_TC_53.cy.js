...
describe('SignalR Notification - Verify system stability during repeated upload notifications', () => {
    ...
    it('SignalR Notification - TC_53', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            notificationPage.SignalRNotification_53();
