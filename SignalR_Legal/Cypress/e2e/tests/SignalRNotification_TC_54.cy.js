...
describe('SignalR Notification - Verify notification appears in notification panel after success', () => {
    ...
    it('SignalR Notification - TC_54', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            notificationPage.SignalRNotification_54();
