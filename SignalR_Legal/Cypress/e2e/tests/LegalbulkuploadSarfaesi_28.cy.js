...
describe('Legal Bulk Upload - Invalid SMS Delivery Date Format Validation', () => {
    ...
    it('TC_028 - Verify upload fails when SMS Delivery Date is entered in an invalid format', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const data = {
                ...
                // Invalid SMS Delivery Date Format
                'M2': '17-07-2026',
