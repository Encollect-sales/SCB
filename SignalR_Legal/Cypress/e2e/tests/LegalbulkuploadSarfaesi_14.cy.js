...
describe('Legal Bulk Upload - Invalid Sarfaesi Status Validation', () => {
    ...
    it('TC_014 - Verify upload fails when an invalid Sarfaesi Status is entered', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const data = {
                ...
                'G2': 'Invalid Status',          // Invalid Sarfaesi Status
