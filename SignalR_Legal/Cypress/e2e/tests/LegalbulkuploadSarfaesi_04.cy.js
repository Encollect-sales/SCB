...
describe('Legal Bulk Upload - Blank Loan Account Number Validation', () => {
    ...
    it('TC_004 - Verify upload fails when Loan Account Number is blank', () => {
