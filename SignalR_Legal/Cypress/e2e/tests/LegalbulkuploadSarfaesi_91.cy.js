...
describe('Legal Bulk Upload - Notice Reference Number Special Characters Validation', () => {
    ...
    it('TC_091 - Verify upload fails when Notice Reference Number contains special characters', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const data = {
                ...
                // Notice Reference Number with Special Characters
                'H2': 'NRN@12345',
