...
describe('Legal Bulk Upload - Valid WhatsApp Delivery Status Validation', () => {
    ...
    it('TC_043 - Verify upload succeeds with a valid WhatsApp Delivery Status', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const data = {
                ...
                // Valid WhatsApp Delivery Status
                'J2': 'Delivered',
