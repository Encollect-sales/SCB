...
describe('SignalR Notification - Verify confirmation popup appears before upload action', () => {
    ...
    it('SignalR Notification - TC_36', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            .then((result) => {
                ...
                // Verify confirmation popup before upload
                notificationPage.SignalRNotification_36(excelFileName);
