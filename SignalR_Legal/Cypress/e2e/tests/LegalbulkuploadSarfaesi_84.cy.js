...
describe('Legal Bulk Upload - Sarfaesi Stage Leading and Trailing Spaces Validation', () => {
    ...
    it('TC_084 - Verify upload succeeds when Sarfaesi Stage contains leading and trailing spaces', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const data = {
                ...
                // Sarfaesi Stage with Leading & Trailing Spaces
