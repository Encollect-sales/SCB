...
describe('Legal Bulk Upload - Invalid Notice Date Format Validation', () => {
    ...
    it('TC_018 - Verify upload fails when Notice Date is entered in an invalid format', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const data = {
                ...
                'I2': '17-07-2026',          // Invalid Date Format
                'J2': 'Delivered',
                'K2': '2026-07-17',
                'L2': 'Delivered',
                'M2': '2026-07-17',
