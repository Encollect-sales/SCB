...
describe('Legal Bulk Upload - Loan Account Number Contains Only Whitespace Validation', () => {
    ...
    it('TC_071 - Verify upload fails when Loan Account Number contains only whitespace', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const data = {
                ...
                // Loan Account Number contains only whitespace
                'B2': '     ',
