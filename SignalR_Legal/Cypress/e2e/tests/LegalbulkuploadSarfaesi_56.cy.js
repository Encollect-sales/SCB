...
describe('Legal Bulk Upload - Valid Physical Delivery Status Validation', () => {
    ...
    it('TC_056 - Verify upload succeeds with a valid Physical Delivery Status', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const data = {
                ...
                // Valid Physical Delivery Status
                'N2': 'Delivered',
