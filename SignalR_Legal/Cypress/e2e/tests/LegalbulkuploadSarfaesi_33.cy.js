...
describe('Legal Bulk Upload - Invalid Physical Delivery Date Format Validation', () => {
    ...
    it('TC_033 - Verify upload fails when Physical Delivery Date is entered in an invalid format', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const data = {
                ...
                // Invalid Physical Delivery Date Format
                'O2': '17-07-2026',
