...
describe('SignalR Notification - Verify error notification is triggered when upload fails', () => {
            ...
            cy.wait(7000);
                                ...
                                .then((result) => {
                                    ...
                                    notificationPage.uploadFile(excelFileName);
                                     notificationPage.SignalRNotification_76(excelFileName);
