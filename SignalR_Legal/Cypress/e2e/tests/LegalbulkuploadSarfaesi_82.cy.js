...
describe('Legal Bulk Upload - Upload Type Special Characters Validation', () => {
    ...
    it('TC_082 - Verify upload fails when Upload Type contains special characters', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const data = {
                ...
                // Upload Type with Special Characters
                'E2': 'Create@',
