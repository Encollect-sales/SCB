...
describe('SignalR Notification - Verify "Clear All" button behavior with no notifications', () => {
             ...
             cy.wait(7000);
                       ...
                       .then((result) => {
                           ...
                           notificationPage.uploadFile(excelFileName);
                            notificationPage.SignalRNotification_08();
