...
describe('Legal Bulk Upload - Loan Account Number Special Characters Validation', () => {
    ...
    it('TC_073 - Verify upload fails when Loan Account Number contains special characters', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const data = {
                ...
                // Loan Account Number with Special Characters
                'B2': '68210000@05802',
