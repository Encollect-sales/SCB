...
describe('Legal Bulk Upload - Sarfaesi Stage Contains Only Whitespace Validation', () => {
    ...
    it('TC_083 - Verify upload fails when Sarfaesi Stage contains only whitespace', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const data = {
                ...
                // Sarfaesi Stage contains only whitespace
                'F2': '     ',
