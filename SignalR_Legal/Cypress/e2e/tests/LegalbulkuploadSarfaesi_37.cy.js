...
describe('Legal Bulk Upload - Notice Reference Number Maximum Length Validation', () => {
    ...
    it('TC_037 - Verify upload fails when Notice Reference Number exceeds maximum length', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            // 51-character Notice Reference Number
            const noticeReferenceNo = faker.string.alphanumeric(51);
