...
describe('Legal Bulk Upload - Invalid Relationship Validation', () => {
    ...
    it('TC_008 - Verify upload fails when an invalid Relationship is entered', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const data = {
                ...
                'B2': '68210000005802',
                'C2': partyName,
                'D2': 'Friend',               // Invalid Relationship
                'E2': 'Create',
