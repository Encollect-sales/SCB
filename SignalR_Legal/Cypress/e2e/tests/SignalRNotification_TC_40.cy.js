...
describe('SignalR Notification - Verify popup closes without action', () => {
    ...
    it('SignalR Notification - TC_40', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            .then((result) => {
                ...
                // Verify popup closes without action
                notificationPage.SignalRNotification_40(excelFileName);
