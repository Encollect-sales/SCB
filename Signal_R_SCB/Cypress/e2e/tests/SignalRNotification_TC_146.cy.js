...
describe('TC_56 - Agency Bulk Deallocation Account Level Telecalling Agency - Verify correct notification message', () => {
    ...
    it('Agency Bulk Deallocation Account Level Telecalling Agency - TC_56', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            .then(() => {
                ...
                notificationPage.verifySuccessNotificationMessage();
