...
describe('SignalR Notification - Verify Mark All as Read works for error notifications', () => {
          ...
          notificationPage.downloadTemplate();
                               ...
                               .then((result) => {
                                   ...
                                   notificationPage.uploadFile(excelFileName);
                                    notificationPage.SignalRNotification_85();
