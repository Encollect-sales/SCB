...
describe('TC_50 - Agency Bulk Deallocation Account Level(field) - Verify no failed notification for successful upload', () => {
    ...
    it('Agency Bulk Deallocation Account Level - TC_50', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            .then(() => {
                ...
                // Verify failed notification is NOT displayed
