...
describe('Verify no failed notification for successful upload', () => {
    ...
    it('Agency Bulk Allocation Customer Level Telecalling Agency - TC_38', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            .then(() => {
                ...
                // Verify failed notification does not exist
