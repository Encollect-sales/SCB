...
describe('TC_254 - Agent Bulk Allocation Account Level Staff - Validate we are getting 3 notifications for a single uploaded file', () => {
    ...
    it('Agent Bulk Allocation Account Level Staff - TC_254', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            .then(() => {
                ...
                // Verify a total of 3 notifications are received for this single file upload
                notificationPage.verifyNotificationCountForUpload(3);
