...
describe('Agent Bulk Allocation Customer Level telecalling - Directing to status page - Verify single notification for successful file upload', () => {
    ...
    it('Agent Bulk Allocation Account Level Agent ', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            notificationPage.downloadTemplateAgentBulkdeAllocationCustomerLevelstaff();
            ...
            .then(() => {
                ...
                notificationPage.uploadFileAgentBulkdeAllocationCustomerLevelstaff(excelFileName);
