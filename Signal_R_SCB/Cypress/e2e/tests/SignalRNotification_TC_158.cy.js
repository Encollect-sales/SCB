...
describe('TC_68 - Agency Bulk Deallocation Customer Level - Verify correct notification message', () => {
    ...
    it('Agency Bulk Deallocation Customer Level - TC_68', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            .then(() => {
                ...
                notificationPage.verifyNotificationMessage(
                    'Agency Bulk Deallocation Customer Level uploaded successfully'
                );
