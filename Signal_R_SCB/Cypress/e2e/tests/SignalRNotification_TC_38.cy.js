...
describe('SignalR Notification - Verify "OK" button functionality in confirmation popup', () => {
    ...
    it('SignalR Notification - TC_38', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            .then(() => {
                ...
                notificationPage.SignalRNotification_38(excelFileName);
