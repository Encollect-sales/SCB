...
describe('TC_256 - Agent Bulk Allocation Account Level Staff - Validate one success notification plus three additional failed notifications are received for the same transaction', () => {
    ...
    it('Agent Bulk Allocation Account Level Staff - TC_256', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            .then(() => {
                ...
                // Verify exactly one success notification is generated
                notificationPage.verifySingleSuccessNotification();

                // // Verify three additional failed notifications are also received for the same transaction
                // notificationPage.verifyFailedNotificationCount(3);
