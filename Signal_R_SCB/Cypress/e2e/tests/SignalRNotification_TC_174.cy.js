...
describe('TC_80 - Agent Bulk Allocation Account Level Staff - Verify correct notification message', () => {
    ...
    it('Agent Bulk Allocation Account Level Staff - TC_80', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            .then(() => {
                ...
                notificationPage.verifyNotificationMessageText('Agent Bulk Allocation Account Level Staff uploaded successfully');
