...
describe('Customer Level Field Agency - Verify multiple sequential uploads', () => {
    ...
    it('Customer Level Field Agency - TC_31', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            .then(() => {
                ...
                // Verify three notifications are displayed
                notificationPage.SignalRNotification_119();
