...
describe('Agency Bulk Allocation Customer Level Telecalling Agency - Validate success notification without additional failed notifications', () => {
    ...
    it('Customer Level Field Agency - TC_247', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            .then(() => {
                ...
                // Verify notification
                // notificationPage.SignalRNotification_125();
