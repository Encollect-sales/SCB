...
describe('TC_57 - Agency Bulk Deallocation Account Level (field) - Verify clicking notification redirects to Agency Allocation Status screen', () => {
    ...
    it('Agency Bulk Deallocation Account Level - TC_57', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            .then(() => {
                ...
                // Verify Agency Allocation Status page is displayed
