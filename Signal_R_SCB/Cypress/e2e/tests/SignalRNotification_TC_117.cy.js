...
describe('Customer Level Field Agency - Verify notification persistence after refresh', () => {
    ...
    it('Customer Level Field Agency - TC_29', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            .then((result) => {
                ...
                notificationPage.verifyNotificationDisplayed();
                ...
                notificationPage.SignalRNotification_117();
