...
describe('TC_249 - Agency Bulk Deallocation Account Level Telecalling Agency - Verify notification is generated only after Transaction ID is displayed', () => {
    ...
    it('Agency Bulk Deallocation Account Level Telecalling Agency - TC_249', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            .then(() => {
                ...
                // Verify only one success notification is displayed
