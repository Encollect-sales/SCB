...
describe('TC_85 - Agent Bulk Allocation Account Level Agent - - Verify single notification for failed file upload', () => {
    ...
    it('Agent Bulk Allocation Account Level Agent - TC_85', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            notificationPage.downloadTemplateAgentBulkAllocationAccountLevelAgent();

            cy.wait(5000);

            const excelFileName = 'ENCollectSecondaryAllocationAgent_Accountlevel.xlsx';
            ...
            .then(() => {
                ...
                notificationPage.uploadFileAgentBulkAllocationAccountLevelAgent(excelFileName);
