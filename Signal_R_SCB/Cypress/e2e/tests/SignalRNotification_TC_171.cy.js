...
describe('TC_77 - Agent Bulk Allocation Account Level Staff - Verify notification persistence after refresh', () => {
    ...
    it('Agent Bulk Allocation Account Level Staff - TC_77', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            .then(() => {
                ...
                // Refresh the page and verify notifications persist
                cy.reload();

                cy.wait(5000);

                notificationPage.verifyNotificationPersistsAfterRefresh();

                // Log out and log back in, then verify notifications persist
                loginPage.login(
                    user.Companyname,
                    user.email,
                    user.password
