...
describe('SignalR Notification - Verify behavior when no unread notifications exist', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            cy.wait(7000);
                                                                   ...
                                                                   .then((result) => {
                                                                       ...
                                                                       // Wait until notification is generated
                                                                       cy.wait(5000);
                                                       
                                                                       // Verify latest notification is displayed first
                                                                       notificationPage.SignalRNotification_28();
