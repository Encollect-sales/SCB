...
describe('TC_63 - Agency Bulk Deallocation Customer Level - Verify unread notification toggle functionality', () => {
    ...
    it('Agency Bulk Deallocation Customer Level - TC_63', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            .then(() => {
                ...
                notificationPage.enableUnreadToggle();
