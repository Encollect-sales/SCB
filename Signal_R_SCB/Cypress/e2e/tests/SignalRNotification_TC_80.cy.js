...
describe('SignalR Notification - Verify error notification title is displayed correctly', () => {
              ...
              notificationPage.downloadTemplate();
                               ...
                               .then((result) => {
                                   ...
                                   notificationPage.uploadFile(excelFileName);
                                    notificationPage.SignalRNotification_80();
