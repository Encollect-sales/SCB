...
describe('SignalR Notification - Verify success notification after upload', () => {
    ...
    it('SignalR Notification - TC_42', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            .then(() => {
                ...
                notificationPage.SignalRNotification_42(excelFileName);
