...
describe('TC_82 - Agent Bulk Allocation Account Level Staff - Verify Clear All button', () => {
    ...
    it('Agent Bulk Allocation Account Level Staff - TC_82', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            .then(() => {
                ...
                // Verify all read and unread notifications are cleared
                notificationPage.verifyNotificationQueueIsEmpty();
