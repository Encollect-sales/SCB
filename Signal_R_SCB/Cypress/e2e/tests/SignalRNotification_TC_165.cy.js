...
describe('TC_253 - Agency Bulk Deallocation Customer Level - Verify notification redirection', () => {
    ...
    it('Agency Bulk Deallocation Customer Level - TC_253', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            .then(() => {
                ...
                notificationPage.verifyRedirectToCustomerLevelDeallocationStatus();
