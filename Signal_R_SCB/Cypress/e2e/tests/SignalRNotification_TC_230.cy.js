...
describe('Allocation Owner Bulk Upload Customer Level- Verify single notification for successful file upload', () => {
    ...
    it('Allocation Owner Bulk Upload Customer Level ', () => {
