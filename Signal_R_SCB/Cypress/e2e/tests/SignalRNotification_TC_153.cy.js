...
describe('TC_64 - Agency Bulk Deallocation Customer Level - Verify unread notification count accuracy', () => {
    ...
    it('Agency Bulk Deallocation Customer Level - TC_64', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            .then(() => {
                ...
                notificationPage.markNotificationAsRead();

                notificationPage.verifyUnreadNotificationCount();
