...
describe('TC_57 - Agency Bulk Deallocation Account Level Telecalling Agency - Verify clicking notification redirects to Agency Allocation Status screen', () => {
    ...
    it('Agency Bulk Deallocation Account Level Telecalling Agency - TC_57', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            .then(() => {
                ...
                // Upload File
                notificationPage.uploadFiletelecustdeallo(excelFileName);
                ...
                notificationPage.clickFirstNotification();

                cy.wait(3000);

                // Verify Agency Allocation Status screen is displayed
                notificationPage.verifyRedirectToAllocationStatus();
