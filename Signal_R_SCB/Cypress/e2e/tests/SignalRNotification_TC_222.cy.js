...
describe('Agent Bulk DeAllocation Customer Level telecaller- Verify single notification for successful file upload', () => {
    ...
    it('Agent Bulk DeAllocation Customer Level telecaller ', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            notificationPage.downloadTemplateAgentBulkdeAllocationLeveltelecaller();
            ...
            .then(() => {
                ...
                notificationPage.uploadFileAgentBulkdeAllocationLeveltelecaller(excelFileName);
                cy.wait(6000);
                notificationPage.verifyTransactionIdDisplayed();
                notificationPage.fileprocessed();
