...
describe('Customer Level Field Agency - Verify unread notification toggle functionality', () => {
    ...
    it('Customer Level Field Agency - Verify unread notification toggle functionality', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            .then((result) => {
                ...
                notificationPage.SignalRNotification_26();

                cy.wait(2000);

                // Enable Unread Toggle
                notificationPage.SignalRNotification_27();
