...
describe('SignalR Notification - Verify "Mark All as Read" button visibility in empty state', () => {
    ...
    it('SignalR Notification - TC_07', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            notificationPage.SignalRNotification_07();
