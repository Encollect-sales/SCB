...
describe('SignalR Notification - Verify transaction ID is auto-populated from notification', () => {
    ...
    it('SignalR Notification - TC_68', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            notificationPage.SignalRNotification_68();
