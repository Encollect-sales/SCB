...
describe('TC_78 - Agent Bulk Allocation Account Level Staff - Verify invalid file upload notification', () => {
    ...
    it('Agent Bulk Allocation Account Level Staff - TC_78', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            // Invalid CollectorCode to force upload failure
            const data = {
                A2: 'INVALID123'
            };
            ...
            .then(() => {
                ...
                notificationPage.verifySingleErrorNotification();
