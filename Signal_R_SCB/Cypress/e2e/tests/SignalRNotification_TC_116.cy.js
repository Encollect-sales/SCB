...
describe('Customer Level Field Agency - TC_28 - Verify unread notification count accuracy', () => {
    ...
    it('Customer Level Field Agency - TC_28 - Verify unread notification count accuracy', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            // Ensure downloaded template exists
            ...
            .then((result) => {
                ...
                notificationPage.captureUnreadCount();

                cy.wait(2000);

                // Mark notification as read
                notificationPage.SignalRNotification_155();

                cy.wait(2000);

                // Verify unread count is updated
                notificationPage.verifyUnreadCountUpdated();
