...
describe('TC_81 - Agent Bulk Allocation Account Level Staff - Verify clicking notification message redirects to Allocation Status Screen', () => {
    ...
    it('Agent Bulk Allocation Account Level Staff - TC_81', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            .then(() => {
                ...
                notificationPage.clickNotificationMessage();

                cy.wait(3000);

                // Verify redirection to Allocation Status Screen
                notificationPage.verifyRedirectedToAllocationStatusScreen();
