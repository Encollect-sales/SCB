...
describe(
  'Agent Bulk Allocation - Account Level Loan (Telecaller → Agent) - Special character filename validation',
  () => {
    ...
    it('Should show error when filename contains special characters', () => {
      getTestData('loginData', 'login2').then(user => {
        ...
        allocationPage.Agent_Bulk_allocation_account_level_loan_account_telecaller_agent_0104();
      });
    });
  }
);
