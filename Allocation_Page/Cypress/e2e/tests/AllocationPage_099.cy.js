...
describe(
  'Agent Bulk Allocation - Account Level Loan (Telecaller → Staff) - Special character filename validation',
  () => {
    ...
    it('Should show error when filename contains special characters', () => {
      getTestData('loginData', 'login2').then(user => {
        ...
        allocationPage.Agent_Bulk_allocation_account_level_loan_account_telecaller_staff_099();
      });
    });
  }
);
