...
describe('TC_0122 | Credit Card | Staff to Telecaller | Upload button enable', () => {
  ...
  it('Should enable Upload button after file selection', () => {
    getTestData('loginData', 'login2').then(user => {
      ...
      allocationPage.Agent_Bulk_allocation_account_level_credit_card_staff_telecaller_0122();
    });
  });
