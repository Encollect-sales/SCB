...
describe(
  'TC-0140 | Agent Bulk Allocation - Account Level | Credit Card | Agent → Telecaller | File Size Validation',
  () => {
    ...
    it('Should show error when uploaded file size exceeds the limit', () => {
