...
describe('TC_0126 | Credit Card | Staff to Telecaller | Empty file upload', () => {
  ...
  it('Should show Failed status for empty file upload', () => {
    getTestData('loginData', 'login2').then(user => {
      ...
      allocationPage.Agent_Bulk_allocation_account_level_credit_card_staff_telecaller_0126();
    });
  });
