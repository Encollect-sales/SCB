...
describe('TC_0125 | Credit Card | Staff to Telecaller | File size validation', () => {
  ...
  it('Should show error when file size exceeds limit', () => {
    getTestData('loginData', 'login2').then(user => {
      ...
      allocationPage.Agent_Bulk_allocation_account_level_credit_card_staff_telecaller_0125();
    });
  });
