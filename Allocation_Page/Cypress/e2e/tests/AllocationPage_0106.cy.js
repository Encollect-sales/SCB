...
describe(
  'Agent Bulk Allocation - Account Level Loan (Telecaller → Agent) - Empty file upload validation',
  () => {
    ...
    it('Should fail allocation when empty file is uploaded', () => {
      getTestData('loginData', 'login2').then(user => {
        ...
        allocationPage.Agent_Bulk_allocation_account_level_loan_account_telecaller_agent_0106();
      });
    });
  }
);
