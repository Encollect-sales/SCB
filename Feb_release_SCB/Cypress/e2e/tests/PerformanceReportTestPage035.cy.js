...
describe('Performance Report (MTD) - All the fields should be visible ', () => {
    ...
    it('All the fields should be visible (MTD)', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            performanceReportPage.PerformanceReportTestPage034();
