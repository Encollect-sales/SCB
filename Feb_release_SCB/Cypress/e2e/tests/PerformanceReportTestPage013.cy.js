...
describe('Performance Page -Verify dependent filters (Product, Sub Product, Country, Region, Branch) are visible', () => {
    ...
    it('Verify dependent filters (Product, Sub Product, Country, Region, Branch) are visible', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            performanceReportPage.PerformanceReportTestPage013();
