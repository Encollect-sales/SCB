...
describe('Performance Page - Verify default month selection is previous month', () => {
    ...
    it('Verify default month selection is previous month', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            performanceReportPage.PerformanceReportTestPage05();
