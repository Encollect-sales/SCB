...
describe('Performance Page - Verify report cannot be generated without month selection', () => {
    ...
    it('Verify report cannot be generated without month selection', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            performanceReportPage.PerformanceReportTestPage015();
