...
describe('Performance Page - Verify Generate Report button is enabled after valid filter selection', () => {
    ...
    it('Verify Generate Report button is enabled after valid filter selection', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            performanceReportPage.PerformanceReportTestPage017();
