...
describe('Performance Page - Verify existing report is renamed to Performance Report (MTD)', () => {
    ...
    it('Verify existing report is renamed to Performance Report (MTD)', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            performanceReportPage.PerformanceReportTestPage02();
