...
describe('Performance Page - Roll Forward count % = (Roll Forward Count / Total Accounts) * 100', () => {
    ...
    it('Roll Forward count % = (Roll Forward Count / Total Accounts) * 100', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            performanceReportPage.PerformanceReportTestPage032();
