...
describe('Account Details - Verify call icon visibility for masked number', () => {
    ...
    it('Verify call icon visibility for masked number', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            accountdetailsPage.AccountDetailsPage02();
