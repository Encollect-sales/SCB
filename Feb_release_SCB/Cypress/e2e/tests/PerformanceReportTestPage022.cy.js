...
describe('Performance Page - Verify delinquent accounts are fetched as of last day of previous month', () => {
    ...
    it('Verify delinquent accounts are fetched as of last day of previous month', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            performanceReportPage.PerformanceReportTestPage022();
