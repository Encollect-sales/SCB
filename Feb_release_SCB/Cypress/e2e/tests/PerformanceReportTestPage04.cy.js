...
describe('Performance Page - Verify month dropdown displays last 13 months', () => {
    ...
    it('Verify month dropdown displays last 13 months', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            performanceReportPage.PerformanceReportTestPage04();
