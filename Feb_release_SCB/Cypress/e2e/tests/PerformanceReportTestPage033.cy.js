...
describe('Performance Page -  Roll Forward BOM POS %  = (Roll Forward BOM POS / Total BOM POS) * 100', () => {
    ...
    it('Roll Forward BOM POS %  = (Roll Forward BOM POS / Total BOM POS) * 100', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            performanceReportPage.PerformanceReportTestPage031();
