...
describe('Performance Page - Verify Monthly Performance Report is visible under Performance Reports', () => {
    ...
    it('Verify Monthly Performance Report is visible under Performance Reports', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            performanceReportPage.PerformanceReportTestPage01();
