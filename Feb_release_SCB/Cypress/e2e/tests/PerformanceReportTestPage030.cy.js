...
describe('Performance Page -Normalization Count % = (Normalization Count / Total Accounts) * 100', () => {
    ...
    it('Normalization Count % = (Normalization Count / Total Accounts) * 100', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            performanceReportPage.PerformanceReportTestPage028();
