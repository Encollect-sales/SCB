...
describe('Performance Page - Verify selected months are displayed in Month field', () => {
    ...
    it('Verify selected months are displayed in Month field', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            performanceReportPage.PerformanceReportTestPage016();
