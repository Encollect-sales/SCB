...
describe('Performance Page - Verify user cannot select more than 6 months', () => {
    ...
    it('Verify user cannot select more than 6 months', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            performanceReportPage.PerformanceReportTestPage06();
