...
describe('Performance Page - Verify Month filter position is next to Product Group', () => {
    ...
    it('Verify Month filter position is next to Product Group', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            performanceReportPage.PerformanceReportTestPage08();
