...
describe('Performance Report (MTD) - Selecting all mandatory fields and select both the options of NPA Fields (Agency Fields)', () => {
    ...
    it(' Selecting all mandatory fields and select both the options of NPA Field(Agency Fields)', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            performanceReportPage.PerformanceReportTestPage038();
