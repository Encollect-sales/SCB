...
describe('Insights Page -  NPA Stage ID filter with values Yes/No is displayed', () => {
    ...
    it('NPA Stage ID filter with values Yes/No is displayed', () => {
