...
describe('Performance Page - Monthly report option is disabled(Telecaller)', () => {
    ...
    it('Monthly report option is disabled(Telecaller)', () => {
        ...
        getTestData('loginData', 'login1').then(user => {
            ...
            performanceReportPage.PerformanceReportTestPage021();
