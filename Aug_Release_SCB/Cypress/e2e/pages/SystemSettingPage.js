...
class SystemSettingPage {
  ...
  SystemSettingTestPage_1091(){
   ...
   // cy.get(this.locators.clickonaddstaff).click();
    ...
    cy.wait(2000);
    cy.get(this.locators.CheackdropdownofbranchName).select('All',{force:true}).should('contain','All');
    cy.wait(2000);
...
cy.wait(2000);
  ...
  SystemSettingTestPage_1119(){
    ...
    cy.get(this.locators.uploadAccountImportStatus).click({force:true});
    cy.wait(2000);
    cy.get('select[name="fileType"]').select('Product Master',{force:true});
    cy.wait(2000);
  ...
  SystemSettingTest_1104(){
    ...
    SystemSettingTestPage_1181(){
      ...
      cy.get(this.locators.ClickBLUM).click({force:true});
      cy.wait(2000);
      cy.get(this.locators.selectMasterTemplate).select('Geo Master')
      cy.wait(2000);
      cy.get(this.locators.SelectPWUF).select('Geo Master');
      cy.wait(2000);
      cy.fixture('BucketMasterTemplate.csv').then((fileContent) => {
        cy.get("input[name='attachedFile']").attachFile({
          fileContent,
  ...
  SystemSettingTestPage_1196(){
    ...
    cy.get(this.locators.accountImportMasterstatus).click({force:true});
    cy.wait(2000);
    cy.get('select[name="fileType"]').select('Geo Master',{force:true});
    cy.wait(2000);
    cy.get('.btn').click({force:true})
    cy.wait(800);
  ...
  SystemSettingTestPage_1120(){
    ...
    cy.get(this.locators.uploadAccountImportStatus).click({force:true});
    cy.wait(800);
    cy.get(this.locators.EnterFileType).select('Product Master',{force:true});
    cy.wait(800);
  ...
  SystemSettingTestPage_1182(){
    ...
    cy.get(this.locators.Downloadproduct).click({force:true}).should('be.visible');
    cy.wait(2000);
    cy.get('.form-inline > .form-control').select('Geo Master',{force:true})
    cy.wait(2000);
    cy.fixture('ProductMasterTemplate.xlsx').then((fileContent) => {
      cy.get("input[name='attachedFile']").attachFile({
        fileContent,
  ...
  ProductMaster1106(){
    ...
    cy.get(this.locators.ClickOnBUM).click({force : true});
    cy.wait(2000);
    cy.get(this.locators.selectMasterTemplate).select('Product Master')
    cy.wait(2000);
    cy.get(this.locators.downloadBucketMaster).click();
    cy.wait(2000);
    cy.log('Template Dowloaded');
    ...
    cy.wait(2000);
    cy.get(this.locators.SelectPWUF).select('Product Master');
    cy.wait(2000);
  ...
  ManageMaster001(){
    cy.wait(2000);
    cy.get(this.locators.clickOnManageMasters).click();
  }
  ...
  ManageMaster002(){
    ...
    cy.get(this.locators.clickOnManageMasters).click();
    cy.wait(2000);
    cy.get(this.locators.clickOnProductHierarchy).click();
    cy.wait(2000);
  }
  ...
  ManageMaster005(){
    ...
    cy.get(this.locators.clickOnManageMasters).click();
    cy.wait(2000);
    cy.get(this.locators.clickOnGeoHierarchy).click();
    cy.wait(2000);
