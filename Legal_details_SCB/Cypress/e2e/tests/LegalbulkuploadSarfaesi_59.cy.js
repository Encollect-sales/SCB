...
describe('Legal Bulk Upload - Valid Physical Delivery Date Validation', () => {
    ...
    it('TC_059 - Verify upload succeeds with a valid Physical Delivery Date', () => {
