...
describe('Case Bulk Upload - Verify Petitioner exceeding maximum length is rejected', () => {
    ...
    it('TC_040 - Verify Petitioner exceeding maximum length is rejected', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const petitioner = faker.string.alphanumeric(201);
                ...
                cy.task('findLatestFile', {
                    ...
                    cy.task('readCsv', filePath).then((rows) => {
                        ...
                        expect(errorRow['Remarks'])
                            .to.contain('Petitioner length is invalid');
