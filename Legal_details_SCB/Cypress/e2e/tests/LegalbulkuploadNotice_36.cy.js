...
describe('Notice Bulk Upload - Enter value exceeding 50 characters', () => {
    ...
    it('TC_WDS_03 - Verify WhatsApp Delivery Status: Enter value exceeding 50 characters', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            // Scenario: Enter value exceeding 50 characters
