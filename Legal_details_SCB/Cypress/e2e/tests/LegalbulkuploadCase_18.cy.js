...
describe('Case Bulk Upload - Case Filing Date Validation - Verify Future Case Filing Date is rejected', () => {
    ...
    it('TC_018 - Verify Future Case Filing Date is rejected', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const filingDate = futureDate.toISOString().split('T')[0];
                ...
                cy.task('findLatestFile', {
                    ...
                    cy.task('readCsv', filePath).then((rows) => {
                        ...
                        expect(errorRow['Remarks'])
                            .to.contains('Invalid Case Filing Date');
