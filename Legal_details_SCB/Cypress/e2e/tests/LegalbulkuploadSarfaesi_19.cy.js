...
describe('Legal Bulk Upload - Future Notice Date Validation', () => {
    ...
    it('TC_019 - Verify upload fails when Notice Date is a future date', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const data = {
                ...
                'I2': '2099-12-31',          // Future Notice Date
                'J2': 'Delivered',
                'K2': '2026-07-17',
                'L2': 'Delivered',
                'M2': '2026-07-17',
