...
describe('Case Bulk Upload - Verify Lawyer at maximum boundary length is accepted', () => {
    ...
    it('TC_049 - Verify Lawyer at maximum boundary length is accepted', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const lawyer = faker.string.alphanumeric(50);
