...
describe('Notice Bulk Upload - Enter a valid status value', () => {
    ...
    it('TC_WDS_01 - Verify WhatsApp Delivery Status: Enter a valid status value', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            // Scenario: Enter a valid status value
