...
describe('Case Bulk Upload - Verify Lawyer exceeding maximum length is rejected', () => {
    ...
    it('TC_051 - Verify Lawyer exceeding maximum length is rejected', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const lawyer = faker.string.alphanumeric(51);
                ...
                cy.task('findLatestFile', {
                    ...
                    cy.task('readCsv', filePath).then((rows) => {
                        ...
                        expect(errorRow['Remarks'])
                            .to.contain('Lawyer length is invalid');
