...
describe('Case Bulk Upload - Loan Account Number Validation - Verify Loan Account Number exceeding maximum length (51 characters)', () => {
    ...
    it('TC_011 - Verify Loan Account Number exceeding maximum length (51 characters)', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const loanAccountNumber = faker.string.alphanumeric(51);
                ...
                cy.task('findLatestFile', {
                    ...
                    cy.task('readCsv', filePath).then((rows) => {
                        ...
                        expect(errorRow['Remarks'])
                            .to.contain('Loan Account Number length is invalid');
