...
describe('Legal Bulk Upload - Relationship Contains Only Whitespace Validation', () => {
    ...
    it('TC_077 - Verify upload succeeds when Relationship contains only whitespace', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const data = {
                ...
                // Relationship contains only whitespace
                'D2': '     ',
            ...
            cy.task('updateLegalBulkCell', {
                ...
                // Move file only after Excel update
