...
describe('Legal Bulk Upload - Upload Correct File With All Mandatory Fields', () => {
    ...
    it('TC_CF_094 - Upload a correctly formatted file with all mandatory fields', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            // Optional:
            // Verify Success Count = 10
            // legalPage.VerifyProcessedRecordCount(10);
