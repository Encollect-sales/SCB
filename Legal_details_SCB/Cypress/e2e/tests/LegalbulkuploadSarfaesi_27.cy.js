...
describe('Legal Bulk Upload - Blank SMS Delivery Date Validation', () => {
    ...
    it('TC_027 - Verify upload processes when SMS Delivery Date is blank', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const data = {
                ...
                // SMS Delivery Date - intentionally blank
                'M2': '',
