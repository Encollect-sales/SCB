...
describe('Legal Bulk Upload - Upload Type Leading and Trailing Spaces Validation', () => {
    ...
    it('TC_081 - Verify upload succeeds when Upload Type contains leading and trailing spaces', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const data = {
                ...
                // Upload Type with Leading & Trailing Spaces
                'E2': '  Create  ',
            ...
            cy.task('updateLegalBulkCell', {
                ...
                // Move updated file only after Excel update is completed
                cy.task('moveAllDownloadsToFixtures').then(result => {
                    ...
                    legalPage.VerifyLegalDetails({
                        ...
                        // Frontend date format: 17-Jul-26
