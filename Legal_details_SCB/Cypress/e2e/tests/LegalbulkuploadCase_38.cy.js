...
describe('Case Bulk Upload - Verify Petitioner at maximum boundary length is accepted', () => {
    ...
    it('TC_038 - Verify Petitioner at maximum boundary length is accepted', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const petitioner = faker.string.alphanumeric(200);
