...
describe('Notice Bulk Upload - Enter a Customer Id that exists in Encollect DB', () => {
    ...
    it('TC_CID_01 - Verify Customer Id: Enter a Customer Id that exists in Encollect DB', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            // Scenario: Enter a Customer Id that exists in Encollect DB
            // Automation note: Master Customer Id CUST10023 must pre-exist in DB.
            //====================================================
