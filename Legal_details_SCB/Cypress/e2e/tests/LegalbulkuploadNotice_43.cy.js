...
describe('Notice Bulk Upload - Enter a valid past/current date in YYYY-MM-DD format', () => {
    ...
    it('TC_SDD_01 - Verify SMS Delivery Date: Enter a valid past/current date in YYYY-MM-DD format', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            //====================================================
            // Build row data for: SMS Delivery Date
            // Scenario: Enter a valid past/current date in YYYY-MM-DD format
