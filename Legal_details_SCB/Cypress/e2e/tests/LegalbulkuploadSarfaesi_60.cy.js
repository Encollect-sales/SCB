...
describe('Legal Bulk Upload - Blank Physical Delivery Date Validation', () => {
    ...
    it('TC_060 - Verify upload fails when Physical Delivery Date is blank', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            // Since Physical Delivery Date is blank,
            // upload should FAIL
            ...
            // Verify that failed upload data was NOT created
