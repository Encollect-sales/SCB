...
describe('Notice Bulk Upload - Status is NOT Delivered (e.g., In Transit) and date is left blank', () => {
    ...
    it('TC_PDD_04 - Verify Physical Delivery Date: Status is NOT Delivered (e.g., In Transit) and date is left blank', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            //====================================================
            // Build row data for: Physical Delivery Date
            // Scenario: Status is NOT 'Delivered' (e.g., 'In Transit') and date is left blank
            // Automation note: Date not required when status != Delivered.
            //====================================================
