...
describe('Legal Bulk Upload - Notice Date Contains Only Whitespace Validation', () => {
    ...
    it('TC_092 - Verify upload fails when Notice Date contains only whitespace', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const data = {
                ...
                // Notice Date contains only whitespace
                'I2': '     ',
