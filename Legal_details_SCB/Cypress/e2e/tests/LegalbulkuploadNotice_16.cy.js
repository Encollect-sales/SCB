...
describe('Notice Bulk Upload - Enter a valid Party Name within 50 characters', () => {
    ...
    it('TC_PN_01 - Verify Party Name: Enter a valid Party Name within 50 characters', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            // Scenario: Enter a valid Party Name within 50 characters
