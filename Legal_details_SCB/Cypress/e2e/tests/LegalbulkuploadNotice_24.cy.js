...
describe('Notice Bulk Upload - Enter Notice Type exceeding 50 characters', () => {
    ...
    it('TC_NT_03 - Verify Notice Type: Enter Notice Type exceeding 50 characters', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            //====================================================
            // Build row data for: Notice Type
            // Scenario: Enter Notice Type exceeding 50 characters
