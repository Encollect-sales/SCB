...
describe('Legal Bulk Upload - SMS Delivery Status Maximum Length Validation', () => {
    ...
    it('TC_051 - Verify upload fails when SMS Delivery Status exceeds maximum length', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const data = {
                ...
                // SMS Delivery Status exceeds maximum length
                'L2': faker.string.alphanumeric(51),
