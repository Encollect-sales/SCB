...
describe('Notice Bulk Upload - Enter Notice Date as todays exact date (boundary)', () => {
    ...
    it('TC_EDG_20 - Verify Notice Date (boundary): Enter Notice Date as todays exact date (boundary)', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            //====================================================
            // Build row data for: Notice Date (boundary)
            // Scenario: Enter Notice Date as today's exact date (boundary)
            // Automation note: Uses system date at runtime, not hardcoded.
            //====================================================
