...
describe('Notice Bulk Upload - Status = Delivered and a future date is entered', () => {
    ...
    it('TC_PDD_03 - Verify Physical Delivery Date: Status = Delivered and a future date is entered', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            // Scenario: Status = 'Delivered' and a future date is entered
            ...
            const data = {
                ...
                L2: '2026-07-21',
                M2: 'Delivered',
                N2: (() => { const d = new Date(); d.setDate(d.getDate() + 1); return d.toISOString().slice(0, 10); })(),
                O2: 'TRK20260722001',
            };
