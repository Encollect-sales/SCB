...
describe('Legal Bulk Upload - Notice Reference Number Leading and Trailing Spaces Validation', () => {
    ...
    it('TC_090 - Verify upload succeeds when Notice Reference Number contains leading and trailing spaces', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const data = {
                ...
                // Notice Reference Number with leading and trailing spaces
            ...
            legalPage.VerifyLegalDetails({
                ...
                // Frontend displays date as 17-Jul-26
