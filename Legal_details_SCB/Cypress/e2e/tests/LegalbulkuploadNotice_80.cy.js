...
describe('Notice Bulk Upload - Enter an invalid calendar date', () => {
    ...
    it('TC_EDG_21 - Verify Notice Date (invalid calendar date): Enter an invalid calendar date', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            //====================================================
            // Build row data for: Notice Date (invalid calendar date)
            // Scenario: Enter an invalid calendar date
