...
describe('Notice Bulk Upload - Enter Relationship exceeding 50 characters', () => {
    ...
    it('TC_REL_03 - Verify Relationship: Enter Relationship exceeding 50 characters', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            //====================================================
            // Build row data for: Relationship
            // Scenario: Enter Relationship exceeding 50 characters
            // Automation note: Generate 51-char string at runtime; confirm rejection vs truncation behavior.
            //====================================================
            ...
            legalPage.VerifyUploadNoticeFailed("Failed");
