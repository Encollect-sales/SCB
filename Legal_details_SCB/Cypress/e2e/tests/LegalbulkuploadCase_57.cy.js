...
describe('Case Bulk Upload - Verify upload with all mandatory and optional fields', () => {
    ...
    it('TC_057 - Verify upload with all mandatory and optional fields', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const subLAN = 'SUB12345';

            const filingDate = '2024-05-10';

            const forum = 'Civil Court';

            const caseType = 'Recovery';
            ...
            const cnrNumber = 'MHPU010012342024';
