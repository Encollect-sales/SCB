...
describe('Notice Bulk Upload - Verify JSON / NoSQL Injection Payload', () => {
    ...
    it('TC_SEC_009 - Verify JSON / NoSQL Injection payload is rejected', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            //====================================================
            // JSON / NoSQL Injection Payload
            //====================================================

            const jsonPayload = '{"$ne":null}';
