...
describe('Legal Bulk Upload - Blank WhatsApp Delivery Status Validation', () => {
    ...
    it('TC_020 - Verify upload processes when WhatsApp Delivery Status is blank', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            // Date displayed on Account Details / Legal Details page
            ...
            const data = {
                ...
                // WhatsApp Delivery Status - intentionally blank
                'J2': '',

                // WhatsApp Delivery Date
                'K2': uploadDate,

                // SMS / Email / Physical status
                'L2': 'Delivered',
                'M2': uploadDate,
                'N2': 'Delivered',
                'O2': uploadDate,
