...
describe('Notice Bulk Upload - Enter date in an incorrect format (e.g., DD-MM-YYYY)', () => {
    ...
    it('TC_ND_04 - Verify Notice Date: Enter date in an incorrect format (e.g., DD-MM-YYYY)', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            // Scenario: Enter date in an incorrect format (e.g., DD-MM-YYYY)
