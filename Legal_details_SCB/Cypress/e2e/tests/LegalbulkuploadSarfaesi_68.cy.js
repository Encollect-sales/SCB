...
describe('Legal Bulk Upload - Customer Id Contains Only Whitespace Validation', () => {
    ...
    it('TC_068 - Verify upload fails when Customer Id contains only whitespace', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const data = {
                ...
                // Customer Id contains only whitespace
                'A2': '     ',
