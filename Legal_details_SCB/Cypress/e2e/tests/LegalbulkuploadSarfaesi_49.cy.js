...
describe('Legal Bulk Upload - Valid SMS Delivery Status Validation', () => {
    ...
    it('TC_049 - Verify upload succeeds with a valid SMS Delivery Status', () => {
