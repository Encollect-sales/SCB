...
describe('Legal Bulk Upload - Future SMS Delivery Date Validation', () => {
    ...
    it('TC_029 - Verify upload fails when SMS Delivery Date is a future date', () => {
