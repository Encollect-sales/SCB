...
describe('Legal Bulk Upload - Notice Date Leading and Trailing Spaces Validation', () => {
    ...
    it('TC_093 - Verify upload succeeds when Notice Date contains leading and trailing spaces', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const data = {
                ...
                // Notice Date with leading and trailing spaces
                'I2': ` ${excelDate} `,
