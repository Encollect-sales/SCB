...
describe('Legal Bulk Upload - Physical Delivery Status Maximum Length Validation', () => {
    ...
    it('TC_058 - Verify upload fails when Physical Delivery Status exceeds maximum length', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const data = {
                ...
                // Physical Delivery Status exceeds maximum length
                'N2': faker.string.alphanumeric(400),
