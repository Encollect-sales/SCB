...
describe('Notice Bulk Upload - Leave WhatsApp Delivery Date blank', () => {
    ...
    it('TC_WDD_02 - Verify WhatsApp Delivery Date: Leave WhatsApp Delivery Date blank', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            // Scenario: Leave WhatsApp Delivery Date blank
