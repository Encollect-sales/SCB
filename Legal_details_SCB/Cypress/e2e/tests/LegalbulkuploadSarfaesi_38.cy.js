...
describe('Legal Bulk Upload - Valid Notice Date Validation', () => {
    ...
    it('TC_038 - Verify upload succeeds with a valid Notice Date', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            legalPage.VerifyLegalDetails({
                ...
                // Application displays date as 17-Jul-26
