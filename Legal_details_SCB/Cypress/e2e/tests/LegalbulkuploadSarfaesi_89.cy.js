...
describe('Legal Bulk Upload - Notice Reference Number Contains Only Whitespace Validation', () => {
    ...
    it('TC_089 - Verify upload fails when Notice Reference Number contains only whitespace', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const data = {
                ...
                // Notice Reference Number contains only whitespace
                'H2': '     ',
