...
describe('Notice Bulk Upload - Enter Notice Date with a valid format but non-numeric characters', () => {
    ...
    it('TC_EDG_22 - Verify Notice Date (non-numeric): Enter Notice Date with a valid format but non-numeric characters', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            //====================================================
            // Build row data for: Notice Date (non-numeric)
            // Scenario: Enter Notice Date with a valid format but non-numeric characters
