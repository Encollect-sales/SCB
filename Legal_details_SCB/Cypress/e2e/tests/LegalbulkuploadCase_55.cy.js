...
describe('Case Bulk Upload - Verify Next Hearing Date as past date is rejected', () => {
    ...
    it('TC_055 - Verify Next Hearing Date as past date is rejected', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            // Past Date
            const nextHearingDate = '2023-12-31';
                ...
                cy.task('findLatestFile', {
                    ...
                    cy.task('readCsv', filePath).then((rows) => {
                        ...
                        expect(errorRow['Remarks'])
                            .to.contain('Invalid Hearing Date');
