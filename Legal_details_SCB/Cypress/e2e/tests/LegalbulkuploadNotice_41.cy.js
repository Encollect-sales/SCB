...
describe('Notice Bulk Upload - Leave SMS Delivery Status blank', () => {
    ...
    it('TC_SDS_02 - Verify SMS Delivery Status: Leave SMS Delivery Status blank', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            //====================================================
            // Build row data for: SMS Delivery Status
            // Scenario: Leave SMS Delivery Status blank
