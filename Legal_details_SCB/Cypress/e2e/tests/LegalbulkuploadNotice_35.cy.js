...
describe('Notice Bulk Upload - Leave WhatsApp Delivery Status blank', () => {
    ...
    it('TC_WDS_02 - Verify WhatsApp Delivery Status: Leave WhatsApp Delivery Status blank', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            //====================================================
            // Build row data for: WhatsApp Delivery Status
            // Scenario: Leave WhatsApp Delivery Status blank
            // Automation note: Field is optional.
            //====================================================
