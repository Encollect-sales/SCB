...
describe('Legal Bulk Upload - Future WhatsApp Delivery Date Validation', () => {
    ...
    it('TC_024 - Verify upload fails when WhatsApp Delivery Date is a future date', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const data = {
                ...
                'I2': '2026-07-17',
                'J2': 'Delivered',
                'K2': '2099-12-31',          // Future WhatsApp Delivery Date
                'L2': 'Delivered',
                'M2': '2026-07-17',
                'N2': 'Delivered',
                'O2': '2026-07-17',
