...
describe('Case Bulk Upload - Sub LAN Validation', () => {
    ...
    it('TC_014 - Verify Sub LAN exceeding maximum length (51 characters)', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const subLAN = faker.string.alphanumeric(51);
                ...
                cy.task('findLatestFile', {
                    ...
                    cy.task('readCsv', filePath).then((rows) => {
                        ...
                        expect(errorRow['Remarks'])
                            .to.contain('Sub LAN length is invalid');

                        // expect(errorRow['Remarks'])
                        //     .to.contain('50');

                        //====================================================
                        // Optional Negative Validations
                        //====================================================
