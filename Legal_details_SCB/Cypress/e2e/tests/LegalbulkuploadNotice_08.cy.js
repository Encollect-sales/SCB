...
describe('Notice Bulk Upload - Enter an Account Number that does not exist in Encollect DB', () => {
    ...
    it('TC_LAN_03 - Verify Loan Account Number: Enter an Account Number that does not exist in Encollect DB', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            //====================================================
            // Build row data for: Loan Account Number
            // Scenario: Enter an Account Number that does not exist in Encollect DB
