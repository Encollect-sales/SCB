...
describe('Legal Bulk Upload - Upload Type Contains Only Whitespace Validation', () => {
    ...
    it('TC_080 - Verify upload fails when Upload Type contains only whitespace', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const data = {
                ...
                // Upload Type contains only whitespace
                'E2': '     ',
