...
describe('Notice Bulk Upload - Enter an Account Number that exists in Encollect DB', () => {
    ...
    it('TC_LAN_01 - Verify Loan Account Number: Enter an Account Number that exists in Encollect DB', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            // Scenario: Enter an Account Number that exists in Encollect DB
            // Automation note: Master Loan Account LN4587963210 must pre-exist in DB.
            //====================================================
