...
describe('Case Bulk Upload - Verify Respondent at maximum boundary length is accepted', () => {
    ...
    it('TC_042 - Verify Respondent at maximum boundary length is accepted', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const respondent = faker.string.alphanumeric(200);
