...
describe('Case Bulk Upload - Loan Account Number Validation', () => {
    ...
    it('TC_008 - Verify Loan Account Number at max boundary length (50 chars)', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const loanAccountNumber =
                'LAN12345678901234567890123456789012345678901234567';
            ...
            const data = {
                ...
                // Loan Account Number - 50 Characters
                ...
                cy.task('findLatestFile', {
                    ...
                    cy.task(
                        ...
                        expect(
                            ...
                            'Loan Account Number does not exist'
                        );
