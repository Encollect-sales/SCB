...
describe('Legal Bulk Upload - Customer Id Leading and Trailing Spaces Validation', () => {
    ...
    it('TC_069 - Verify upload succeeds when Customer Id contains leading and trailing spaces', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const data = {
                ...
                // Customer Id with leading and trailing spaces
                'A2': ' 210000001692 ',
