...
describe('Case Bulk Upload - Case Filing Date Validation - Verify Case Filing Date left blank', () => {
    ...
    it('TC_017 - Verify Case Filing Date left blank', () => {
            ...
            legalPage.getTransactionId().then((txnIdRaw) => {
                ...
                cy.task('findLatestFile', {
                    ...
                    cy.task('readCsv', filePath).then((rows) => {
                        ...
                        expect(errorRow['Remarks']).to.equal('Case Filing Date is Required');
