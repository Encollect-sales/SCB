...
describe('Legal Bulk Upload - Relationship Special Characters Validation', () => {
    ...
    it('TC_079 - Verify upload succeeds when Relationship contains special characters', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const data = {
                ...
                // Relationship with special character
                'D2': 'Father@',
