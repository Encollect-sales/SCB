...
describe('Notice Bulk Upload - Enter a valid Relationship value within 50 characters', () => {
    ...
    it('TC_REL_01 - Verify Relationship: Enter a valid Relationship value within 50 characters', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            // Scenario: Enter a valid Relationship value within 50 characters
