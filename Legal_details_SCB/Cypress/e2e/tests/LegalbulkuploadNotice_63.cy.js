...
describe('Notice Bulk Upload - Enter Customer Id with a leading space', () => {
    ...
    it('TC_EDG_04 - Verify Customer Id (whitespace): Enter Customer Id with a leading space', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            // Scenario: Enter Customer Id with a leading space
