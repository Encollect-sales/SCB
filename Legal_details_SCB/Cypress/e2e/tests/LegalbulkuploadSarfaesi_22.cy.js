...
describe('Legal Bulk Upload - Blank WhatsApp Delivery Date Validation', () => {
    ...
    it('TC_022 - Verify upload processes when WhatsApp Delivery Date is blank', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            // Date displayed on Account Details page
            ...
            const data = {
                ...
                // WhatsApp Delivery Date - intentionally blank
                'K2': '',
            ...
            legalPage.VerifyLegalDetails({
                ...
                // WhatsApp Delivery Date is blank in Excel
                whatsappDate: '',
