...
describe('Legal Bulk Upload - Blank Tracking ID Validation', () => {
    ...
    it('TC_064 - Verify upload fails when Tracking ID is blank', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            // Blank Tracking ID should make upload FAIL
            ...
            // Only pass Notice Reference Number because Tracking ID is blank
