...
describe('Case Bulk Upload - File Number Validation', () => {
    ...
    it('TC_006 - Verify File Number exceeding maximum length (51 characters)', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const fileNumber = faker.string.alphanumeric(51);
                ...
                cy.task('findLatestFile', {
                    ...
                    cy.task('readCsv', filePath).then((rows) => {
                        ...
                        expect(errorRow['Remarks'])
                            .to.contain('File Number length is invalid');
