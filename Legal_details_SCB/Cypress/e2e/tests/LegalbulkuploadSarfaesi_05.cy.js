...
describe('Legal Bulk Upload - Invalid Loan Account Number Validation', () => {
    ...
    it('TC_005 - Verify upload fails when Loan Account Number is invalid', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const data = {
                ...
                'A2': '210000001692',
                'B2': '99999999999999',      // Invalid Loan Account Number
                'C2': partyName,
                'D2': 'Father',
                'E2': 'Create',
