...
describe('Notice Bulk Upload - Leave SMS Delivery Date blank', () => {
    ...
    it('TC_SDD_02 - Verify SMS Delivery Date: Leave SMS Delivery Date blank', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            // Scenario: Leave SMS Delivery Date blank
