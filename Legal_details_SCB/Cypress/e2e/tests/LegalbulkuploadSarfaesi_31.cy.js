...
describe('Legal Bulk Upload - Invalid Physical Delivery Status Validation', () => {
    ...
    it('TC_031 - Verify upload processes when Physical Delivery Status is invalid', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const data = {
                ...
                // Invalid Physical Delivery Status
                'N2': 'Completed',
