...
describe('Case Bulk Upload - Case Filing Date Validation - Verify Case Filing Date in invalid format is rejected', () => {
    ...
    it('TC_019 - Verify Case Filing Date in invalid format is rejected', () => {
                ...
                cy.task('findLatestFile', {
                    ...
                    cy.task('readCsv', filePath).then((rows) => {
                        ...
                        expect(errorRow['Remarks'])
                            .to.contain('Case Filing Date must be in yyyy-MM-dd format');

                        //====================================================
                        // Ensure no other validation errors
                        //====================================================
