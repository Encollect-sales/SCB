...
describe('Legal Bulk Upload - Blank WhatsApp Delivery Status Validation', () => {
    ...
    it('TC_044 - Verify upload succeeds when WhatsApp Delivery Status is blank', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const data = {
                ...
                // Blank WhatsApp Delivery Status
                'J2': '',

                // Blank WhatsApp Delivery Date
                'K2': '',
