...
describe('Notice Bulk Upload - Enter a valid status (e.g., Delivered)', () => {
    ...
    it('TC_PDS_01 - Verify Physical Delivery Status: Enter a valid status (e.g., Delivered)', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            // Scenario: Enter a valid status (e.g., Delivered)
