...
describe('Notice Bulk Upload - Enter a valid Tracking Id', () => {
    ...
    it('TC_PTI_01 - Verify Physical Tracking Id: Enter a valid Tracking Id', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            // Scenario: Enter a valid Tracking Id
