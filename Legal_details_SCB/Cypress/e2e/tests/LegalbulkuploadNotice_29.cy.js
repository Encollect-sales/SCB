...
describe('Notice Bulk Upload - Enter Notice Reference Number exceeding 50 characters', () => {
    ...
    it('TC_NRN_05 - Verify Notice Reference Number: Enter Notice Reference Number exceeding 50 characters', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            // Scenario: Enter Notice Reference Number exceeding 50 characters
