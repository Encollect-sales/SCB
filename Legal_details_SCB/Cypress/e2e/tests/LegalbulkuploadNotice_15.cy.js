...
describe('Notice Bulk Upload - Enter Create with a Notice Reference Number that already exists in DB', () => {
    ...
    it('TC_UT_06 - Verify Upload Type: Enter Create with a Notice Reference Number that already exists in DB', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            //====================================================
            // Build row data for: Upload Type
            // Scenario: Enter 'Create' with a Notice Reference Number that already exists in DB
            // Automation note: Pre-insert a record with the same Notice Reference Number before running.
            //====================================================
