...
describe('Legal Bulk Upload - Invalid Sarfaesi Stage Validation', () => {
    ...
    it('TC_012 - Verify upload fails when an invalid Sarfaesi Stage is entered', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const data = {
                ...
                'D2': 'Father',
                'E2': 'Create',
                'F2': 'Invalid Stage',          // Invalid Sarfaesi Stage
                'G2': 'In Progress',
