...
describe('Notice Bulk Upload - Status = Delivered and a valid past/current date is entered', () => {
    ...
    it('TC_PDD_01 - Verify Physical Delivery Date: Status = Delivered and a valid past/current date is entered', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            // Scenario: Status = 'Delivered' and a valid past/current date is entered
