...
describe('Notice Bulk Upload - Enter Party Name exceeding 50 characters', () => {
    ...
    it('TC_PN_03 - Verify Party Name: Enter Party Name exceeding 50 characters', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            //====================================================
            // Build row data for: Party Name
            // Scenario: Enter Party Name exceeding 50 characters
