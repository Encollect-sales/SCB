...
describe('Legal Bulk Upload - Blank Physical Delivery Status Validation', () => {
    ...
    it('TC_057 - Verify upload fails when Physical Delivery Status is blank', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const data = {
                ...
                // Blank Physical Delivery Status
                'N2': '',
