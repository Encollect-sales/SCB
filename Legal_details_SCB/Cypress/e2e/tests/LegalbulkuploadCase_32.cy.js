...
describe('Case Bulk Upload - Verify Current Year Case Year is accepted', () => {
    ...
    it('TC_032 - Verify Current Year Case Year is accepted', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const caseYear = new Date().getFullYear().toString();
