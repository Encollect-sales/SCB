...
describe('Notice Bulk Upload - Enter Customer Id exceeding 50 characters', () => {
    ...
    it('TC_CID_04 - Verify Customer Id: Enter Customer Id exceeding 50 characters', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            // Scenario: Enter Customer Id exceeding 50 characters
