...
describe('Case Bulk Upload - Forum Validation', () => {
    ...
    it('TC_023 - Verify Forum exceeding maximum length is rejected', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const forum = faker.string.alphanumeric(201);
                ...
                cy.task('findLatestFile', {
                    ...
                    cy.task('readCsv', filePath).then((rows) => {
                        ...
                        expect(errorRow['Remarks'])
                            .to.contain('Forum length is invalid');
