...
describe('Legal Bulk Upload - Sarfaesi Status Leading and Trailing Spaces Validation', () => {
    ...
    it('TC_087 - Verify upload succeeds when Sarfaesi Status contains leading and trailing spaces', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const data = {
                ...
                // Sarfaesi Status with Leading & Trailing Spaces
                'G2': '  In Progress  ',
            ...
            legalPage.VerifyLegalDetails({
                ...
                // Frontend date format is 17-Jul-26
