...
describe('Legal Bulk Upload - Invalid WhatsApp Delivery Date Format Validation', () => {
    ...
    it('TC_023 - Verify upload fails when WhatsApp Delivery Date is entered in an invalid format', () => {
        ...
        getTestData('loginData', 'login').then(user => {
            ...
            const data = {
                ...
                'I2': '2026-07-17',
                'J2': 'Delivered',
                'K2': '17-07-2026',          // Invalid WhatsApp Delivery Date Format
                'L2': 'Delivered',
                'M2': '2026-07-17',
                'N2': 'Delivered',
                'O2': '2026-07-17',
