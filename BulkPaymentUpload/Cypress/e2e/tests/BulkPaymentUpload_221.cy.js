...
describe('Bulk Payment Upload - Drawee Branch Name Blank', () => {
    ...
    it('To verify that when Mode of Payment is Cheque and Drawee Branch Name is left blank, the system should reject the record and display an appropriate validation message.', () => {
