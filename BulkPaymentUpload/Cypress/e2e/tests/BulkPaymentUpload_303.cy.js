...
describe('Bulk Payment Upload - Drawee Branch Name Blank for Cheque', () => {
    ...
    it('Verify upload fails when Drawee Branch Name is blank for Cheque payment', () => {
