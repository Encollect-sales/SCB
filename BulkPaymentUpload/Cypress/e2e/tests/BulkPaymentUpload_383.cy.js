...
describe('Bulk Payment Upload - Reports Visibility', () => {
    ...
    it('To verify that the uploaded receipt is visible in Reports.', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            paymentPage.verifyReceiptInReports(receiptNo2);
        });
