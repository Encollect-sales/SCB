...
describe('Bulk Payment Upload - External Transaction ID with Special Characters', () => {
    ...
    it('Verify that the system rejects the upload when External System Transaction ID contains only special characters', () => {
