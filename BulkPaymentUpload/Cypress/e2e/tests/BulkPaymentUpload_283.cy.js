...
describe('Bulk Payment Upload - Cheque Mode with Instrument Number Containing Special Characters', () => {
    ...
    it('To verify that the system rejects the upload when the Cheque Number contains special characters.', () => {
