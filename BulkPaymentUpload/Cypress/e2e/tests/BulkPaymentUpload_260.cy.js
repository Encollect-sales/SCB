...
describe('Bulk Payment Upload - Physical Receipt Number Exceeds 50 Characters', () => {
    ...
    it('To verify that the system rejects the record when Physical Receipt Number exceeds 50 characters.', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            const physicalReceipt = faker.string.alphanumeric(55);
