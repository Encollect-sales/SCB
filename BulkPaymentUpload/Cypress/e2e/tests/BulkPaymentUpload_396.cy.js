...
describe('Bulk Payment Upload - Successful Records Excluded From Error Report', () => {
    ...
    it('To verify that successful records are not present in the error report.', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            paymentPage.verifyErrorReportExcludesRecords([receiptNo2]);
        });
