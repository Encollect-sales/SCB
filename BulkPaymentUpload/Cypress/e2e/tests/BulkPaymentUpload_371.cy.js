...
describe('Bulk Payment Upload - Transfers with Breakup Amount Equal to Receipt Amount', () => {
    ...
    it('To verify that a Bulk Payment record with Mode of Payment "Transfers" is uploaded successfully when CC Breakup amount equals the Receipt Amount.', () => {
