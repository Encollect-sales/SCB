...
describe('Bulk Payment Upload - Online Payment with Instrument Number', () => {
    ...
    it('To verify that the system rejects the record when Instrument Number is populated for Online Payment mode.', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            const data = {
                ...
                // Instrument Date
                'H2': '',
                // Instrument Number (populated - not applicable)
                'I2': chequeNo,
