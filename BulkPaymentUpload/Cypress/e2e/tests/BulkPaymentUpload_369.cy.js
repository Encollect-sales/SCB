...
describe('Bulk Payment Upload - Other with Leading and Trailing Spaces', () => {
    ...
    it('To verify that the system rejects the record when Mode of Payment " Other " contains leading/trailing spaces.', () => {
