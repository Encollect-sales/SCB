...
describe('Bulk Payment Upload - Invalid Receipt Time Format', () => {
    ...
    it('To verify that when Receipt Time is entered in an invalid format, the system rejects the record and displays an appropriate validation message.', () => {
