...
describe('Bulk Payment Upload - Drawee Branch Name Exceeds 50 Characters', () => {
    ...
    it('Verify upload fails when Drawee Branch Name exceeds 50 characters', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            const branchName = 'ABCDEFGHIJKLMNOPQRSTUVWXYZABCDEFGHIJKLMNOPQRSTUVWXY';
