...
describe('Bulk Payment Upload - Transfers with Instrument Date', () => {
    ...
    it('To verify that the system rejects the record when Instrument Date is populated for Transfers mode.', () => {
