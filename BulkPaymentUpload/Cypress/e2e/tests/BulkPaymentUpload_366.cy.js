...
describe('Bulk Payment Upload - Mode of Payment OTHER in Uppercase', () => {
    ...
    it('To verify that the system rejects the record when Mode of Payment is entered in uppercase as "OTHER".', () => {
