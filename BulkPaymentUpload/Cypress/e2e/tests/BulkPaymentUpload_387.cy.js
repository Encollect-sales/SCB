...
describe('Bulk Payment Upload - One Valid and One Invalid Record', () => {
    ...
    it('To verify that a file with one valid and one invalid record results in a "Partially Processed" file status.', () => {
