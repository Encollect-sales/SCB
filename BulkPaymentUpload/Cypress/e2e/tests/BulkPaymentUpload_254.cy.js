...
describe('Bulk Payment Upload - Invalid Relationship With Customer', () => {
    ...
    it('To verify that when an invalid Relationship With Customer is entered, the system rejects the record and displays an appropriate validation message.', () => {
