...
describe('Bulk Payment Upload - Online Payment with Breakup Amount Equal to Receipt Amount', () => {
    ...
    it('To verify that a Bulk Payment record with Mode of Payment "Online Payment" is uploaded successfully when CC Breakup amount equals the Receipt Amount.', () => {
