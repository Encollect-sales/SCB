...
describe('Bulk Payment Upload - Future Receipt Date', () => {
    ...
    it('To verify that when a future Receipt Date is entered in the Bulk Payment upload file, the system identifies the invalid date, marks the record as failed, and displays an appropriate validation error message.', () => {
