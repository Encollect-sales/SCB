...
describe('Bulk Payment Upload - Negative Receipt Amount', () => {
    ...
    it('To verify that when a negative Receipt Amount is entered in the Bulk Payment upload file, the system identifies the invalid value, marks the record as failed, and displays an appropriate validation error message.', () => {
