...
describe('Bulk Payment Upload - Transfers with Bank Name', () => {
    ...
    it('To verify that the system rejects the record when Drawee Bank Name is populated for Transfers mode.', () => {
