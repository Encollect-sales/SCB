...
describe('Bulk Payment Upload - Account Number Exceeds 32 Characters', () => {
    ...
    it('To verify that the system rejects the record when Account Number exceeds 32 characters.', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            const accountNumber = faker.string.numeric(35);
