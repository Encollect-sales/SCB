...
describe('Bulk Payment Upload - Mode of Payment Blank', () => {
    ...
    it('To verify that when the Mode of Payment column is left blank in the Bulk Payment upload file, the system identifies the missing value, marks the record as failed, and displays an appropriate validation error message.', () => {
