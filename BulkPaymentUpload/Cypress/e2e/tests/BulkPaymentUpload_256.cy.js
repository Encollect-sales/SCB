...
describe('Bulk Payment Upload - Receipt Amount Contains Alphabetic Characters', () => {
    ...
    it('To verify that the system rejects the record when Receipt Amount contains alphabetic characters.', () => {
