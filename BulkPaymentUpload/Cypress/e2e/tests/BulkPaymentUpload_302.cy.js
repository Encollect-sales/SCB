...
describe('Bulk Payment Upload - Drawee Bank Name Blank for Cheque', () => {
    ...
    it('Verify upload fails when Drawee Bank Name is blank for Cheque payment', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            const data = {
                ...
                // Mandatory fields for Cheque
                'F2': '',                  // Drawee Bank Name (Blank)
                'G2': 'MG Road Branch',
                'H2': '2025-09-22',
                'I2': chequeNo,
                'J2': '',
