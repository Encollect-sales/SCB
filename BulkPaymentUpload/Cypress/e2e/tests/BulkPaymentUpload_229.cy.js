...
describe('Bulk Payment Upload - Future Receipt Time', () => {
    ...
    it('To verify that when the Receipt Time is greater than the current time for the current Receipt Date, the system rejects the record and displays an appropriate validation message.', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            const ss = String(futureTime.getSeconds()).padStart(2, '0');
