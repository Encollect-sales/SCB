...
describe('Bulk Payment Upload - Receipt Amount More Than Two Decimal Places', () => {
    ...
    it('Verify that the system rejects the upload when Receipt Amount has more than two decimal places', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            const data = {
                ...
                // Invalid Receipt Amount (3 decimal places)
                'D2': '500.123',
                ...
                // Breakup Amount (matching receipt amount intentionally)
                'Q2': '500.123',
                'R2': '0',
                'S2': '0',
                'T2': '0',
