...
describe('Bulk Payment Upload - Cheque Mode with Instrument Number Less Than Minimum Length', () => {
    ...
    it('To verify that the system rejects the upload when the Cheque Number is less than the minimum allowed length.', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            const data = {
                ...
                // Invalid Cheque Number (too short)
                'F2': '12',
                'G2': '2025-09-20',
                'H2': 'HDFC Bank',
                'I2': 'HDFC0001234',
