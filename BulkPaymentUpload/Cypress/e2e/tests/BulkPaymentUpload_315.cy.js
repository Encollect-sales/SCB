...
describe('Bulk Payment Upload - Drawee Bank Name Exceeds 50 Characters', () => {
    ...
    it('Verify upload fails when Drawee Bank Name exceeds 50 characters', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            // Bank Name > 50 Characters
            const bankName = 'ABCDEFGHIJKLMNOPQRSTUVWXYZABCDEFGHIJKLMNOPQRSTUVWXY';
