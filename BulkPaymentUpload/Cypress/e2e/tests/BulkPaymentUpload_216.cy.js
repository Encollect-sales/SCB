...
describe('Bulk Payment Upload - Receipt Amount Zero', () => {
    ...
    it('To verify that when Receipt Amount is entered as zero in the Bulk Payment upload file, the system identifies the invalid value, marks the record as failed, and displays an appropriate validation error message.', () => {
