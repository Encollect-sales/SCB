...
describe('Bulk Payment Upload - Mode of Payment online payment in Lowercase', () => {
    ...
    it('To verify that the system rejects the record when Mode of Payment is entered in lowercase as "online payment".', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            const data = {
                ...
                // Receipt Amount
                'D2': '500',
                // Mode Of Payment (lowercase - invalid)
                'E2': 'online payment',
                // Drawee Bank Name
                'F2': '',
                // Drawee Branch Name
