...
// Note: 'CC' in the test data/descriptions below stands for Credit Card
describe('Bulk Payment Upload - Transfers with IFSC Code', () => {
    ...
    it('To verify record handling when IFSC Code (Deposit Branch Code) is populated for Transfers mode - validate against BRD (update BulkPaymentUpload_Failed to BulkPaymentUpload_Success below if BRD marks IFSC mandatory for Transfers).', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            const data = {
                ...
                // Instrument Number
                'I2': '',
                // Deposit Branch Code (IFSC) (validate as per BRD)
                'J2': 'HDFC0001234',
                // Receipt Time
                'K2': '11:11:11',
