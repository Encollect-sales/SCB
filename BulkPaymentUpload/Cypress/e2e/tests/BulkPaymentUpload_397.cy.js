...
describe('Bulk Payment Upload - Failed Records Not Created', () => {
    ...
    it('To verify that failed records are not created in the system.', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            paymentPage.verifyRecordNotInSystem(transactionId3);
        });
