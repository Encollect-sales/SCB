...
describe('Bulk Payment Upload - Invalid Instrument Date Format', () => {
    ...
    it('To verify that when Mode of Payment is Cheque and Instrument Date is entered in an invalid format, the system rejects the record and displays an appropriate validation message.', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            const instrumentNo = faker.string.numeric(8);
