...
describe('Bulk Payment Upload - Cash Mode with All CC Breakup Amounts as Zero', () => {
    ...
    it('To verify that the system rejects the upload when Receipt Amount is greater than zero but all CC Breakup Amounts are zero.', () => {
