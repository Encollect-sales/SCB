...
describe('Bulk Payment Upload - Only EMI Overdue Amount Entered', () => {
    ...
    it('To verify that when only EMI Overdue Amount is entered and it is equal to the Receipt Amount, the record is uploaded successfully.', () => {
