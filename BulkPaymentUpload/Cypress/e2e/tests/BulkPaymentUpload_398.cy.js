...
describe('Bulk Payment Upload - Successful Records Created Despite Partial Failure', () => {
    ...
    it('To verify that successful records are created in the system despite partial failures.', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            paymentPage.verifyRecordInSystem(receiptNo2);
        });
