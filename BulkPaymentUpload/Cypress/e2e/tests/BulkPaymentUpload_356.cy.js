...
describe('Bulk Payment Upload - Other with Instrument Number', () => {
    ...
    it('To verify that the system rejects the record when Instrument Number is populated for Other mode.', () => {
