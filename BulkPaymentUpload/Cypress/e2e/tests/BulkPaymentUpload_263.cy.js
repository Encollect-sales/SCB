...
describe('Bulk Payment Upload - Tax Registration Number Exceeds 50 Characters', () => {
    ...
    it('To verify that the system rejects the record when Tax Registration Number exceeds 50 characters.', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            const panNumber = faker.string.alphanumeric(55);
