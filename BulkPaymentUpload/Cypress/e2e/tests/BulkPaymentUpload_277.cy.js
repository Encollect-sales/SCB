...
describe('Bulk Payment Upload - Cash Mode with IFSC Entered', () => {
    ...
    it('To verify that the system rejects the upload when IFSC is provided for Cash payment mode.', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            const data = {
                ...
                'G2': '',
                'H2': '',
                'I2': 'HDFC0001234', // IFSC entered for Cash
                'J2': '',
