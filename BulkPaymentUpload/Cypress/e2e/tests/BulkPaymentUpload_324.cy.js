...
describe('Bulk Payment Upload - Mode of Payment Blank with Bank and Branch Name Populated', () => {
    ...
    it('Verify upload fails when Mode of Payment is blank but Bank Name and Branch Name are populated', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            const data = {
                ...
                // Mode of Payment Blank
                'E2': '',

                // Bank & Branch populated
                'F2': 'HDFC Bank',
                'G2': 'MG Road Branch',
