...
describe('Bulk Payment Upload - Breakup Amount Decimal Precision Mismatch', () => {
    ...
    it('Verify upload fails when breakup amount precision causes mismatch with Receipt Amount', () => {
