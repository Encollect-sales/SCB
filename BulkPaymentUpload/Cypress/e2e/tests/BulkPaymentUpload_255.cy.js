...
describe('Bulk Payment Upload - Receipt Amount with More Than 2 Decimal Places', () => {
    ...
    it('To verify that the system rejects the record when Receipt Amount contains more than two decimal places.', () => {
