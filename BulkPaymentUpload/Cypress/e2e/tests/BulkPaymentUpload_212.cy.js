...
describe('Bulk Payment Upload - Receipt Date Blank', () => {
    ...
    it('To verify that when the Receipt Date column is left blank in the Bulk Payment upload file, the system identifies the missing value, marks the record as failed, and displays an appropriate validation error message.', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            cy.task('updateBulkPaymentCell', {
                ...
                cy.log('Excel file updated successfully');
