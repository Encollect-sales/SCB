...
describe('Bulk Payment Upload - Future Receipt Time', () => {
    ...
    it('To verify that when Receipt Time is greater than the current system time for the current date, the system rejects the record and displays an appropriate validation message.', () => {
