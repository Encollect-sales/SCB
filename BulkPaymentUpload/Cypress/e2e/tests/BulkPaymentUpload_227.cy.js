...
describe('Bulk Payment Upload - Future Instrument Date', () => {
    ...
    it('To verify that when Mode of Payment is Cheque and a future Instrument Date is entered, the system rejects the record and displays an appropriate validation message.', () => {
