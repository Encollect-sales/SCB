...
describe('Bulk Payment Upload - Verify Receipt Status OpsAcknowledgedInBulk', () => {
    ...
    it('Verify successfully uploaded receipt gets OpsAcknowledgedInBulk status', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            paymentPage.SearchReceipt(transactionId);
            paymentPage.VerifyReceiptStatus('OpsAcknowledgedInBulk');
