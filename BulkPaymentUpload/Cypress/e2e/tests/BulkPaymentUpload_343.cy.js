...
describe('Bulk Payment Upload - Valid Online Payment', () => {
    ...
    it('To verify that a Bulk Payment record with Mode of Payment as "Online Payment" is uploaded successfully.', () => {
