...
describe('Bulk Payment Upload - Receipt Amount Contains Alphabets', () => {
    ...
    it('Verify that the system rejects the upload when Receipt Amount contains alphabetic characters', () => {
