...
describe('Bulk Payment Upload - Collector Name Blank Verification', () => {
    ...
    it('To verify that the Collector Name remains blank for a bulk uploaded receipt.', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            paymentPage.verifyCollectorNameBlank(receiptNo2);
        });
