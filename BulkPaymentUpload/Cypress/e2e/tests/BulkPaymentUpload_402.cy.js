...
describe('Bulk Payment Upload - Processing Continues Past First Failure', () => {
    ...
    it('To verify that upload processing completes for the entire file without stopping at the first failed record.', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            paymentPage.verifyAllRecordsProcessed(3);
            paymentPage.verifyFailureCount(2);
            paymentPage.verifySuccessCount(1);
        });
