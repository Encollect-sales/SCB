...
describe('Bulk Payment Upload - Single Breakup Amount Does Not Match Receipt Amount', () => {
    ...
    it('Verify upload fails when only one breakup amount is populated and does not equal Receipt Amount', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            const data = {
                ...
                // Only one breakup field populated with incorrect amount
                'Q2': '300',
