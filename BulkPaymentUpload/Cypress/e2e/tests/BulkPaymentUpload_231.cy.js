...
describe('Bulk Payment Upload - External System Transaction ID Blank', () => {
    ...
    it('To verify that when the External System Transaction ID is left blank in the Bulk Payment upload file, the system identifies the missing value, marks the record as failed, and displays an appropriate validation error message.', () => {
