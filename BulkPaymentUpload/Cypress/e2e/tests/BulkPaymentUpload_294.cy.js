...
describe('Bulk Payment Upload - Receipt Time with Special Characters', () => {
    ...
    it('Verify that the system rejects the upload when Receipt Time contains special characters', () => {
