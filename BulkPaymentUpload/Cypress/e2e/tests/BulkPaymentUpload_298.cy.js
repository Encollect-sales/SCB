...
describe('Bulk Payment Upload - Receipt Amount Exceeds Maximum Limit', () => {
    ...
    it('Verify upload fails when Receipt Amount exceeds decimal(18,2) limit', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            const data = {
                ...
                // Invalid Receipt Amount (19 digits before decimal)
                'D2': '1234567891234567899.99',
