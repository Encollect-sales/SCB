...
describe('Bulk Payment Upload - Cash Mode with Instrument Number Entered', () => {
    ...
    it('To verify that the system rejects the upload when Instrument Number is provided for Cash payment mode.', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            const data = {
                ...
                'F2': '123456789', // Instrument Number
                'G2': '',
                'H2': '',
                'I2': '',
                'J2': '',
