...
describe('Bulk Payment Upload - Mandatory Header Renamed', () => {
    ...
    it('To verify that the system rejects the upload when a mandatory column header is renamed.', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            cy.task('renameHeader', {
                filePath: sourceFilePath,
                sheetName,
                oldHeader: 'Account Number',
                newHeader: 'Account No'
            });
