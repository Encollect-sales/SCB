...
describe('Bulk Payment Upload - Other with Branch Name', () => {
    ...
    it('To verify that the system rejects the record when Drawee Branch Name is populated for Other mode.', () => {
