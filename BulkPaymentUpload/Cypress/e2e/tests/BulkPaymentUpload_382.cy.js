...
describe('Bulk Payment Upload - Payment History Visibility', () => {
    ...
    it('To verify that the uploaded receipt is visible in Payment History.', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            paymentPage.verifyReceiptInPaymentHistory(receiptNo2);
        });
