...
describe('Bulk Payment Upload - No SMS Notification Verification', () => {
    ...
    it('To verify that no SMS notification is triggered after successful bulk upload.', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            paymentPage.verifyNoSmsNotification(receiptNo2);
        });
