...
describe('Bulk Payment Upload - Online Payment with Branch Name Populated', () => {
    ...
    it('To verify that the system rejects the record when Drawee Branch Name is populated for Online Payment mode.', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            const data = {
                ...
                // Drawee Bank Name
                'F2': '',
                // Drawee Branch Name (populated - not applicable)
                'G2': 'MG Road Branch',
                // Instrument Date
                'H2': '',
                // Instrument Number
