...
describe('Bulk Payment Upload - Only Bounce Charges Entered', () => {
    ...
    it('To verify that when only Bounce Charges is entered and it is equal to the Receipt Amount, the record is uploaded successfully.', () => {
