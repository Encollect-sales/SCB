...
describe('Bulk Payment Upload - Receipt Amount Blank', () => {
    ...
    it('To verify that when the Receipt Amount column is left blank in the Bulk Payment upload file, the system identifies the missing value, marks the record as failed, and displays an appropriate validation error message without processing the invalid entry.', () => {
