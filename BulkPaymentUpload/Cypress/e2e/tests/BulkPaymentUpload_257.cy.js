...
describe('Bulk Payment Upload - Receipt Amount Contains Special Characters', () => {
    ...
    it('To verify that the system rejects the record when Receipt Amount contains special characters.', () => {
