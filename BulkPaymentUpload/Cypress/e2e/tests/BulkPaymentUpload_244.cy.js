...
describe('Bulk Payment Upload - Only CC Breakup1 Amount Entered', () => {
    ...
    it('To verify that when only CC Breakup1 Amount is entered and it is equal to the Receipt Amount, the record is uploaded successfully.', () => {
