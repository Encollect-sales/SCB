...
describe('Bulk Payment Upload - Duplicate External System Transaction ID', () => {
    ...
    it('To verify that valid records are processed and a record with a duplicate External System Transaction ID is rejected.', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            const data = {
                // ---- Row 2 (valid) ----
                'A2': transactionId2, 'B2': '4726428046987990', 'C2': '2025-09-23', 'D2': '500', 'E2': 'Cash',
                ...
                // ---- Row 3 (valid) ----
                'A3': transactionId3, 'B3': '4726428046987990', 'C3': '2025-09-23', 'D3': '500', 'E3': 'Cash',
                ...
                'A4': transactionId2, 'B4': '4726428046987990', 'C4': '2025-09-23', 'D4': '500', 'E4': 'Cash',
