...
describe('Bulk Payment Upload - Online Payment with Bank Name Populated', () => {
    ...
    it('To verify that the system rejects the record when Drawee Bank Name is populated for Online Payment mode.', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            const data = {
                ...
                // Mode Of Payment
                'E2': 'Online Payment',
                // Drawee Bank Name (populated - not applicable)
                'F2': 'HDFC Bank',
                // Drawee Branch Name
                'G2': '',
                // Instrument Date
