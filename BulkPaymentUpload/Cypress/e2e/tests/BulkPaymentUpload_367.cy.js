...
describe('Bulk Payment Upload - Online Payment with Leading and Trailing Spaces', () => {
    ...
    it('To verify that the system rejects the record when Mode of Payment " Online Payment " contains leading/trailing spaces.', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            const data = {
                ...
                // Receipt Amount
                'D2': '500',
                // Mode Of Payment (leading/trailing spaces - invalid)
                'E2': ' Online Payment ',
                // Drawee Bank Name
                'F2': '',
                // Drawee Branch Name
