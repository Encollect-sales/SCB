...
describe('Bulk Payment Upload - Columns Reordered', () => {
    ...
    it('To verify that the system rejects the upload when the template columns are reordered.', () => {
