...
describe('Bulk Payment Upload - Duplicate Instrument Number', () => {
    ...
    it('To verify that the system rejects the record when the same Instrument Number already exists for the same Bank and Instrument Date.', () => {
