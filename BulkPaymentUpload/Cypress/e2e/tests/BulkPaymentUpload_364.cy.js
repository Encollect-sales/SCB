...
describe('Bulk Payment Upload - Mode of Payment ONLINE PAYMENT in Uppercase', () => {
    ...
    it('To verify that the system rejects the record when Mode of Payment is entered in uppercase as "ONLINE PAYMENT".', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            const data = {
                ...
                // Receipt Amount
                'D2': '500',
                // Mode Of Payment (uppercase - invalid)
                'E2': 'ONLINE PAYMENT',
                // Drawee Bank Name
                'F2': '',
                // Drawee Branch Name
