...
describe('Bulk Payment Upload - Online Payment with IFSC Code', () => {
    ...
    it('To verify that the system rejects the record when IFSC Code (Deposit Branch Code) is populated for Online Payment mode.', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            const data = {
                ...
                // Instrument Number
                'I2': '',
                // Deposit Branch Code (IFSC) (populated - not applicable)
                'J2': 'HDFC0001234',
                // Receipt Time
                'K2': '11:11:11',
