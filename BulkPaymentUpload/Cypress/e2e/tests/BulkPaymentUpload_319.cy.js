...
describe('Bulk Payment Upload - External System Transaction ID Contains Only Whitespace', () => {
    ...
    it('Verify upload fails when External System Transaction ID contains only whitespace', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            const data = {
                ...
                // Transaction ID contains only spaces
                'A2': '     ',
