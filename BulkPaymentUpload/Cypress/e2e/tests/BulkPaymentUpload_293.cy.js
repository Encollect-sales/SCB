...
describe('Bulk Payment Upload - Receipt Time with Alphabetic Characters', () => {
    ...
    it('Verify that the system rejects the upload when Receipt Time contains alphabetic characters', () => {
