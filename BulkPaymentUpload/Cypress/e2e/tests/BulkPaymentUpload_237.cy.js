...
describe('Bulk Payment Upload - Sum of Breakup Amounts Less than Receipt Amount', () => {
    ...
    it('To verify that when the sum of all breakup amounts is less than the Receipt Amount, the system rejects the record and displays an appropriate validation message.', () => {
