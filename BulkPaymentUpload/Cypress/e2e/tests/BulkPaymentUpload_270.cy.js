...
describe('Bulk Payment Upload - Mixed Valid and Invalid Records Upload', () => {
    ...
    it('To verify the system behavior when the upload contains both valid and invalid records.', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            const data = {
                ...
                // Row 3 - Invalid Record (Blank Account Number)
                'A3': txn2,
                'B3': '',
                'C3': '2025-09-23',
                'D3': '700',
