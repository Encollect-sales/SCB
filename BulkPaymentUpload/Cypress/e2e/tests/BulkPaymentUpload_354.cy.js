...
describe('Bulk Payment Upload - Transfers with Branch Name', () => {
    ...
    it('To verify that the system rejects the record when Drawee Branch Name is populated for Transfers mode.', () => {
