...
describe('Bulk Payment Upload - Multiple Validation Failures', () => {
    ...
    it('To verify that all invalid records are rejected with respective error messages while valid records are processed.', () => {
