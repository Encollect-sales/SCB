...
describe('Bulk Payment Upload - Other with IFSC Code', () => {
    ...
    it('To verify that the system rejects the record when IFSC Code (Deposit Branch Code) is populated for Other mode.', () => {
