...
describe('Bulk Payment Upload - Receipt Status Verification', () => {
    ...
    it('To verify that the uploaded receipt status is "OpsAcknowledgedInBulk".', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            paymentPage.verifyReceiptStatus(receiptNo2, 'OpsAcknowledgedInBulk');
        });
