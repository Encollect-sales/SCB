...
describe('Bulk Payment Upload - Invalid PAN Number', () => {
    ...
    it('To verify that when an invalid PAN Number is entered in the Tax Registration Number field, the system rejects the record and displays an appropriate validation message.', () => {
