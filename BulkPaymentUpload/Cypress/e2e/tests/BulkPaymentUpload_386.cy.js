...
describe('Bulk Payment Upload - No Email Notification Verification', () => {
    ...
    it('To verify that no Email notification is triggered after successful bulk upload.', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            paymentPage.verifyNoEmailNotification(receiptNo2);
        });
