...
describe('Bulk Payment Upload - Duplicate Physical Receipt Number', () => {
    ...
    it('To verify that the system rejects the record when the Physical Receipt Number already exists.', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            const data = {
                ...
                // Use an existing Physical Receipt Number
                'L2': 'PR123456',
