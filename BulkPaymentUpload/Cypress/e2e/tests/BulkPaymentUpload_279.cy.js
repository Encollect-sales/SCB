...
describe('Bulk Payment Upload - Cash Mode with Instrument Date Entered', () => {
    ...
    it('To verify that the system rejects the upload when Instrument Date is provided for Cash payment mode.', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            const data = {
                ...
                'F2': '',
                'G2': '2025-09-20', // Instrument Date entered
                'H2': '',
                'I2': '',
                'J2': '',
