...
describe('Bulk Payment Upload - Mode of Payment with Leading and Trailing Spaces', () => {
    ...
    it('Verify upload fails when Mode of Payment contains leading/trailing spaces', () => {
