...
describe('Bulk Payment Upload - Instrument Date Blank', () => {
    ...
    it('To verify that when Mode of Payment is Cheque and Instrument Date is left blank, the system should reject the record and display an appropriate validation message.', () => {
