...
describe('Bulk Payment Upload - Mode of Payment other in Lowercase', () => {
    ...
    it('To verify that the system rejects the record when Mode of Payment is entered in lowercase as "other".', () => {
