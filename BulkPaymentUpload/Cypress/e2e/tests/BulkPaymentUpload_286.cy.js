...
describe('Bulk Payment Upload - DD Mode with DD Number Containing Special Characters', () => {
    ...
    it('To verify that the system rejects the upload when the DD Number contains special characters.', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            const data = {
                ...
                // DD Number with Special Characters
                'F2': 'DD@123#45',
