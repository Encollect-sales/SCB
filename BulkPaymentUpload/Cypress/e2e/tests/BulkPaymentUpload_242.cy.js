...
describe('Bulk Payment Upload - Only Penal Charges Entered', () => {
    ...
    it('To verify that when only Penal Charges is entered and it is equal to the Receipt Amount, the record is uploaded successfully.', () => {
