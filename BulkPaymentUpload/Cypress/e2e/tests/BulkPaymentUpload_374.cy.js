...
describe('Bulk Payment Upload - Cheque Mode', () => {
    ...
    it('To verify that a Bulk Payment record with Mode of Payment "Cheque" is uploaded successfully.', () => {
