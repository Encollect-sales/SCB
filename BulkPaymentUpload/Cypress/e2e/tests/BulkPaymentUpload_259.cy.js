...
describe('Bulk Payment Upload - Agency ID Exceeds 32 Characters', () => {
    ...
    it('To verify that the system rejects the record when Agency ID exceeds 32 characters.', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            const agencyId = faker.string.alphanumeric(35);
