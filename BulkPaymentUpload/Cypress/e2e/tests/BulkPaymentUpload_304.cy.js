...
describe('Bulk Payment Upload - Instrument Date Blank for Cheque', () => {
    ...
    it('Verify upload fails when Instrument Date is blank for Cheque payment', () => {
