...
describe('Bulk Payment Upload - Deposit Branch Code Exceeds 20 Characters', () => {
    ...
    it('To verify that the system rejects the record when Deposit Branch Code (IFSC) exceeds 20 characters.', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            const ifscCode = faker.string.alphanumeric(25);
