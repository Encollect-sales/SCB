...
describe('Bulk Payment Upload - Invalid Collector ID', () => {
    ...
    it('To verify that when an invalid Collector ID is entered in the Bulk Payment upload file, the system rejects the record and displays an appropriate validation error message.', () => {
