...
describe('Bulk Payment Upload - Transfers with Leading and Trailing Spaces', () => {
    ...
    it('To verify that the system rejects the record when Mode of Payment " Transfers " contains leading/trailing spaces.', () => {
