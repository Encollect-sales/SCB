...
describe('Bulk Payment Upload - Valid Transfers Payment', () => {
    ...
    it('To verify that a Bulk Payment record with Mode of Payment as "Transfers" is uploaded successfully.', () => {
