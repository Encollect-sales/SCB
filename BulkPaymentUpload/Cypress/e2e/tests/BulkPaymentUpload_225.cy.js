...
describe('Bulk Payment Upload - Instrument Number should be blank for Cash Payment', () => {
    ...
    it('To verify that when Mode of Payment is Cash and Instrument Number is entered, the system rejects the record and displays an appropriate validation message.', () => {
