...
describe('Bulk Payment Upload - Instrument Number Exceeds Maximum Length', () => {
    ...
    it('Verify upload fails when Instrument Number exceeds 32 characters', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            // 33-character Instrument Number
            const instrumentNumber = '123456789012345678901234567890123';
