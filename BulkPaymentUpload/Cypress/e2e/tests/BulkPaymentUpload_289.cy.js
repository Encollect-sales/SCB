...
describe('Bulk Payment Upload - External Transaction ID Greater Than 32 Characters', () => {
    ...
    it('Verify that the system rejects the upload when External System Transaction ID exceeds 32 characters', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            const transactionId = faker.string.alphanumeric(33); // Invalid (>32 characters)
