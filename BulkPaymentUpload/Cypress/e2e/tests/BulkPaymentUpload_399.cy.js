...
describe('Bulk Payment Upload - Error Report Row Mapping', () => {
    ...
    it('To verify that the row numbers in the error report match the uploaded Excel rows.', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            paymentPage.verifyErrorReportRowMapping([3, 4]);
        });
