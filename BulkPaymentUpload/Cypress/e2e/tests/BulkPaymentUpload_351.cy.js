...
describe('Bulk Payment Upload - Transfers with Instrument Number', () => {
    ...
    it('To verify that the system rejects the record when Instrument Number is populated for Transfers mode.', () => {
