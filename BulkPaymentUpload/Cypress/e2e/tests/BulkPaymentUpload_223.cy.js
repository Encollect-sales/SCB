...
describe('Bulk Payment Upload - Instrument Number Blank', () => {
    ...
    it('To verify that when Mode of Payment is Cheque and Instrument Number is left blank, the system should reject the record and display an appropriate validation message.', () => {
