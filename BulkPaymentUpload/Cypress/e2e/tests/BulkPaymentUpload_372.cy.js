...
describe('Bulk Payment Upload - Other with Breakup Amount Equal to Receipt Amount', () => {
    ...
    it('To verify that a Bulk Payment record with Mode of Payment "Other" is uploaded successfully when CC Breakup amount equals the Receipt Amount.', () => {
