...
describe('Bulk Payment Upload - Duplicate External System Transaction ID', () => {
    ...
    it('To verify that when a duplicate External System Transaction ID is entered in the Bulk Payment upload file, the system rejects the record and displays an appropriate validation error message.', () => {
