...
describe('Bulk Payment Upload - Relationship With Customer Exceeds 100 Characters', () => {
    ...
    it('To verify that the system rejects the record when Relationship With Customer exceeds 100 characters.', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            const relationship = faker.string.alpha(101);
