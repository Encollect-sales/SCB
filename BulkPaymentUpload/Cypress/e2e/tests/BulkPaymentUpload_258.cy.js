...
describe('Bulk Payment Upload - External System Transaction ID Exceeds 32 Characters', () => {
    ...
    it('To verify that the system rejects the record when External System Transaction ID exceeds 32 characters.', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            const transactionId = faker.string.alphanumeric(40);
