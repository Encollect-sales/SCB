...
describe('Bulk Payment Upload - Account Number Greater Than 32 Characters', () => {
    ...
    it('Verify that the system rejects the upload when Account Number exceeds 32 characters', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            // Generate 33-digit Account Number
            const accountNumber = faker.string.numeric(33);

            const data = {

                'A2': transactionId,

                // Invalid Account Number (>32 Characters)
                'B2': accountNumber,
