...
describe('Bulk Payment Upload - All Breakup Amounts are Zero', () => {
    ...
    it('To verify that when all breakup amounts are zero, the system rejects the record and displays an appropriate validation message.', () => {
