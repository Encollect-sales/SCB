...
describe('Bulk Payment Upload - Cash Mode with Bank Name Entered', () => {
    ...
    it('To verify that the system rejects the upload when Bank Name is provided for Cash payment mode.', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            const data = {
                ...
                'F2': '',
                'G2': '',
                'H2': 'HDFC Bank',   // Bank Name entered for Cash
                'I2': '',
                'J2': '',
