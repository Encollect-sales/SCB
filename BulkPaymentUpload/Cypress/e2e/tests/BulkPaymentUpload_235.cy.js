...
describe('Bulk Payment Upload - Collector does not belong to Agency', () => {
    ...
    it('To verify that when the Collector ID does not belong to the specified Agency ID, the system rejects the record and displays an appropriate validation error message.', () => {
