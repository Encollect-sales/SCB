...
describe('Bulk Payment Upload - Blank Agency ID with Collector ID Present', () => {
    ...
    it('Verify system behaviour when Agency ID is blank and Collector ID is provided', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            // Update based on actual application behaviour
