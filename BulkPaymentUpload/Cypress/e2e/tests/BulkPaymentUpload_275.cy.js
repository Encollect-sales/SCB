...
describe('Bulk Payment Upload - Mandatory Header Removed', () => {
    ...
    it('To verify that the system rejects the upload when a mandatory column header is removed.', () => {
