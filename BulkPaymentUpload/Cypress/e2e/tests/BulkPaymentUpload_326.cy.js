...
describe('Bulk Payment Upload - Collector ID Exceeds 32 Characters', () => {
    ...
    it('Verify upload fails when Collector ID exceeds 32 characters', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            // Collector ID = 33 Characters
            const collectorId = 'ABCDEFGHIJKLMNOPQRSTUVWXYZ1234567';
