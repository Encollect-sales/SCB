...
describe('Bulk Payment Upload - Receipt Amount Mismatch with CC Breakup Total', () => {
    ...
    it('To verify that the system rejects the record when Receipt Amount does not match the CC Breakup Total.', () => {
