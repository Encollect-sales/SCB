...
describe('Bulk Payment Upload - Only Settlement Amount Entered', () => {
    ...
    it('To verify that when only Settlement Amount is entered and it is equal to the Receipt Amount, the record is uploaded successfully.', () => {
