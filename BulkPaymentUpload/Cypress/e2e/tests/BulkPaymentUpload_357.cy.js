...
describe('Bulk Payment Upload - Other with Instrument Date', () => {
    ...
    it('To verify that the system rejects the record when Instrument Date is populated for Other mode.', () => {
