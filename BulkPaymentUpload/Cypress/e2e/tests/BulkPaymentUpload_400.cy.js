...
describe('Bulk Payment Upload - Upload Summary Counts', () => {
    ...
    it('To verify that the upload summary displays the total, success, and failure record counts correctly.', () => {
        ...
        getTestData('loginData', 'login2').then(user => {
            ...
            paymentPage.verifyUploadSummary(3, 2, 1);
        });
