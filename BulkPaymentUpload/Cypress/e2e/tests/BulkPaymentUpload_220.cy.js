...
describe('Bulk Payment Upload - Drawee Bank Name Blank', () => {
    ...
    it('To verify that when Mode of Payment is Cheque and Drawee Bank Name is left blank, the system should reject the record and display an appropriate validation message.', () => {
