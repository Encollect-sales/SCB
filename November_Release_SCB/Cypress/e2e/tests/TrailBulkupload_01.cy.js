...
describe('Trail Scenarios - PTP Bulk Upload', () => {
  ...
  // =====================================================
  // TC_ID_001 - Download template, update Excel and upload
  // =====================================================
  it('TC_ID_001 - PTP account bulk upload with random PTP amount (1–100)', () => {
    ...
    getTestData('loginData', 'login2').then(user => {
      ...
      // ---------------- Excel Cell Data ----------------
      const data = {
        'A2': '68190000222635',      // Agreement id
        'B2': '54535',               // Agent ENCollect Code
        'C2': 'yes',                 // RightPartyContact
        'D2': 'PTP',                // Action Code
        'E2': 'PTP',                // ResultCode
        'F2': '2027/01/29',         // Next Action Date
