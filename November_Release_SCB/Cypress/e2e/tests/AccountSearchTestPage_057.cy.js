...
describe('Account Search - Verify Previous and Next buttons are displayed in Account Details screen', () => {
    let loginPage;
    ...
    it('AccountSearch - Account Search- TC_ID_057', () => {
        getTestData('loginData', 'login2').then(user => {
            loginPage.login(user.Companyname, user.email, user.password);
                cy.wait(5000);
                accountsearchpage.TC_57();            
            });
        });
    });