...
describe('BULKTRL_006 - Pending Approval Agent Validation', () => {
  ...
  it('Process file with Pending Approval agents only', () => {
    ...
    getTestData('loginData', 'login').then(user => {
      ...
      // ---------------- Excel Data (ONLY Pending Approval Agents) ----------------
      const data = {
        'A2': 'DMI0009601001',
        'B2': '2003',                 // Pending Approval
        'C2': 'Yes',
        'D2': 'PTP',
        'E2': 'PTP',
        'F2': '2025/12/26',
