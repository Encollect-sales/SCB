...
describe('Add Staff - Department and Designations - User should be able to add department & designations by selecting department as "Branch Frontend" and designation as "Branch Tele collection officer"', () => {
    let loginPage;
