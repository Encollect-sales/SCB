...
describe('Add Staff - Department and Designations - .User should be able to add department & designations by selecting department as "Collections" and designation as "Collections supervisor"', () => {
    let loginPage;
