...
describe('Add Staff - Add Staff - User clicked on last name field but did not enter any value then system should show an error as "Last Name is required" below to the field.', () => {
    let loginPage;
    let addStaffPage;  
