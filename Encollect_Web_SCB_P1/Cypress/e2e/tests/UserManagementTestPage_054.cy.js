...
describe('User Management- User Management -User to enter First Name in the bulk upload of agency and user creation', () => {
    ...
    it('Payment - TC_ID_054', () => { 
        getTestData('loginData', 'login2').then(user => {
            ...
            cy.wait(2000);
            usermanagementpage.UserManagementTestPage_054_File_Download();
            ...
            const data = {
                ...
                'K2': "22/01/2029",  // Random Date of Birth (born before 2000)
            ...
            cy.task('updateAgentTemplateCell', {
                ...
                cy.wait(2000);   
                usermanagementpage.UserManagementTestPage_054_File_Upload();              
            });
        });
    });
}); 
