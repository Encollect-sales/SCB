...
describe('User Management- User Management -User to enter First Name in the bulk upload of agency and user creation', () => {
    ...
    it('Payment - TC_ID_060', () => { 
        getTestData('loginData', 'login2').then(user => {
            ...
            cy.wait(2000);
            usermanagementpage.UserManagementTestPage_060_File_Download();
            ...
            const data = {
                ...
                'Q2': " 23/01/2029",  // Random Employment Date (5 years ago)
            ...
            cy.task('updateAgentTemplateCell', {
                ...
                cy.wait(2000);   
                usermanagementpage.UserManagementTestPage_060_File_Upload();              
            });
        });
    });
}); 
