...
describe('UserManagement - Add Staff - User clicked on employee id field but did not enter any value then system should show an error as "employee id is required" below to the field.', () => {
    let loginPage;
    let addStaffPage;  
