...
describe('Add Staff - Department and Designations - User should be able to add department & designations by selecting department as "Branch Backend" and designation as "Branch Manager"', () => {
    let loginPage;
