...
describe('User management - Department and Designations - Branch Cashier - .User should be able to add department & designations by selecting department as "Branch Backend" and designation as "Branch Cashier user can also click on add button to add one more department and designation', () => {
    let loginPage;
