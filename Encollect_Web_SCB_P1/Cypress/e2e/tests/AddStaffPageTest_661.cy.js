...
describe('Add Staff - Department and Designations - User should be able to add department & designations by selecting department as "Collections staff backend" and designation as "Bank collections backend"', () => {
    let loginPage;
