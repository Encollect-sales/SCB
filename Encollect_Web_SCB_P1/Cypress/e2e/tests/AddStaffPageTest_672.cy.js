...
describe('Department and Designations - User should be able to add department & designations by selecting department as "CRM" and designation as "Head CRM" user can also click on add button to add one more department and designation', () => {
    let loginPage;
