...
describe('Add Staff - Department and Designations - User should be able to add department & designations by selecting department as "Recovery" and designation as "Recovery Officer"', () => {
    let loginPage;
