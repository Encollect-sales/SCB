...
describe('User Management- User Management -User to enter First Name in the bulk upload of agency and user creation', () => {
    ...
    it('Payment - TC_ID_071', () => { 
        getTestData('loginData', 'login2').then(user => {
            ...
            cy.wait(2000);
            usermanagementpage.UserManagementTestPage_071_File_Download();
            ...
            const data = {
                ...
                'H2': "@#$%^&*",  // Random DRA Unique Registration Number
            ...
            cy.task('updateAgentTemplateCell', {
                ...
                cy.wait(2000);   
                usermanagementpage.UserManagementTestPage_071_File_Upload();              
            });
        });
    });
}); 
