...
describe('Add Staff - Department and Designations - User should be able to add department & designations by selecting department as "Collections staff frontend" and designation as "Product collections head"', () => {
    let loginPage;
