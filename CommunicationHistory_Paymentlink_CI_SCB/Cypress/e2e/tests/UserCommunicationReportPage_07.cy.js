...
describe('Credit Card -Mail- Verify user can navigate to Send Duplicate Receipt and enter Account Number with current From and To dates',()=>{
    let loginPage;
    ...
    it('TC_030 - Verify user can navigate to Send Duplicate Receipt and enter Account Number with current From and To dates',()=>{
        getTestData('loginData','login').then(user=>{
            ...
            userCommunicationReportPage.enterAccountNumberAndCurrentDatecc();
            userCommunicationReportPage.Accountdetailscheckhistorymailcc();
