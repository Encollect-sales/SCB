...
describe('CC - Account Details - Verify Status in Communication History',()=>{
let loginPage;
...
it('Verify Status is displayed in Communication History',()=>{
...
userCommunicationReportPage.verifyCommunicationHistoryStatus();
});
});
});