...
describe('CC - Account Details - Verify Channel in Communication History',()=>{
let loginPage;
...
it('Verify Channel is displayed in Communication History',()=>{
...
userCommunicationReportPage.verifyCommunicationHistoryChannel();
});
});
});