...
describe('UAT-014 - Channel Effectiveness - Communication Level',()=>{
let loginPage;
...
it('Verify Channel Effectiveness Communication Level',()=>{
...
cy.wait(2000);
campaignInsightsPage.verifyChannelCommunicationLevel();
});
});
});