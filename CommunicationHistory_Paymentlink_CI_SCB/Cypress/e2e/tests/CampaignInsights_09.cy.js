...
describe('UAT-009 - Verify Campaign Effectiveness Account Level',()=>{
let loginPage;
...
it('Verify Campaign Effectiveness Account Level',()=>{
...
cy.wait(2000);
campaignInsightsPage.verifyCampaignAccountLevel();
});
});
});