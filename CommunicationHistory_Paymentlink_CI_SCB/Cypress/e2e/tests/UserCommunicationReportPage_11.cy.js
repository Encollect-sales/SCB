...
describe('CC - Verify Payment Link request is captured in Communication History',()=>{
    let loginPage;
    ...
    it('Verify Payment Link request is captured in Communication History',()=>{
        getTestData('loginData','login').then(user=>{
            ...
            userCommunicationReportPage.AccountdetailscheckhistorysendpyCC();
            userCommunicationReportPage.accountdetailspycc();
