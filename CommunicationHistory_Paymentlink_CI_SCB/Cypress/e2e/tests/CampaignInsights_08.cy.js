...
describe('UAT-008 - Verify Contactable and Non-Contactable Percentage',()=>{
let loginPage;
...
it('Verify Contactable and Non-Contactable percentages',()=>{
...
cy.wait(2000);
campaignInsightsPage.verifyContactablePercentage();
});
});
});