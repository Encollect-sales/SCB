...
describe('CC - Account Details - Verify Communication Trigger in Communication History',()=>{
let loginPage;
...
it('Verify Communication Trigger is displayed in Communication History',()=>{
...
userCommunicationReportPage.verifyCommunicationHistoryTrigger();
});
});
});