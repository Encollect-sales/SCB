...
describe('CC - Account Details - Verify Communication Template in Communication History',()=>{
let loginPage;
...
it('Verify Communication Template is displayed in Communication History',()=>{
...
userCommunicationReportPage.verifyCommunicationHistoryTemplate();
});
});
});