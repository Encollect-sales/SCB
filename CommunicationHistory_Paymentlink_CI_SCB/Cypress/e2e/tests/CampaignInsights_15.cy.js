...
describe('UAT-015 - KPI Consistency',()=>{
let loginPage;
...
it('Verify Total Accounts consistency across dashboard and campaign data',()=>{
...
cy.wait(2000);
campaignInsightsPage.verifyTotalAccountsConsistency();
});
});
});