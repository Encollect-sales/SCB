...
describe('CC - Account Details - Verify Payment Link request is captured in Communication History',()=>{
    let loginPage;
    ...
    it('Verify Payment Link request is captured in Communication History',()=>{
        getTestData('loginData','login').then(user=>{
            ...
            userCommunicationReportPage.AcnumbersendpaymentCC();
            userCommunicationReportPage.accountdetailspyacCC();
