...
describe('Communication Template - Verify Payment Link placement', () => {
    let loginPage;
    ...
    it('TC_005 - Verify Payment Link placement', () => {
        getTestData('loginData', 'login').then(user => {
            ...
            communicationTemplatePage.enterTemplateBody('Payment Link: ');
