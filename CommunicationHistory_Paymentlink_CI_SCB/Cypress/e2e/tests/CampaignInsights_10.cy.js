...
describe('UAT-010 - Verify Campaign Effectiveness Communication Level',()=>{
let loginPage;
...
it('Verify Campaign Effectiveness Communication Level',()=>{
...
cy.wait(2000);
campaignInsightsPage.verifyCampaignCommunicationLevel();
});
});
});