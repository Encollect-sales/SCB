...
describe('CC - Account Details - Verify Communication ID in Communication History',()=>{
let loginPage;
...
it('Verify Communication ID is displayed in Communication History',()=>{
...
userCommunicationReportPage.verifyCommunicationHistoryCommunicationID();
});
});
});