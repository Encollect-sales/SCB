...
describe('UAT-006 - Verify Empty Result for Campaign Insights',()=>{
let loginPage;
...
it('Verify Empty State is displayed when filters return no completed runs',()=>{
...
cy.wait(2000);
campaignInsightsPage.verifyEmptyResult();
});
});
});