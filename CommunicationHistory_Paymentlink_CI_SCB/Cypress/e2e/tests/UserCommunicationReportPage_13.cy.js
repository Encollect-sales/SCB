...
describe('Account Details - Verify Date & Time in Communication History',()=>{
let loginPage;
...
it('Verify Date & Time is displayed in Communication History',()=>{
...
userCommunicationReportPage.dateandtime();
