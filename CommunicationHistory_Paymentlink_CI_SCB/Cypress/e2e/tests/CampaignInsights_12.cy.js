...
describe('UAT-012 - Runs Drill Down Disabled for Single Run',()=>{
let loginPage;
...
it('Verify Runs Drill Down is disabled for single run',()=>{
...
cy.wait(2000);
campaignInsightsPage.verifySingleRunNoDrillDown();
});
});
});