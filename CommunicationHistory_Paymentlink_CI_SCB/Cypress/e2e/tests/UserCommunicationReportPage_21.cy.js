...
describe('CC - Account Details - Verify Pagination in Communication History',()=>{
let loginPage;
...
it('Verify Pagination is working in Communication History',()=>{
...
userCommunicationReportPage.verifyCommunicationHistoryPagination();
});
});
});